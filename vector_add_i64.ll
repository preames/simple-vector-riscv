...
for.body.preheader:                               ; preds = %entry
  ...
  %min.iters.check = icmp ult i32 %a_len, 4
  br i1 %min.iters.check, label %for.body.preheader8, label %vector.ph

vector.ph:                                        ; preds = %for.body.preheader
  %n.vec = and i64 %wide.trip.count, 4294967292
  %broadcast.splatinsert = insertelement <2 x i64> poison, i64 %b, i64 0
  %broadcast.splat = shufflevector <2 x i64> %broadcast.splatinsert, <2 x i64> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert6 = insertelement <2 x i64> poison, i64 %b, i64 0
  %broadcast.splat7 = shufflevector <2 x i64> %broadcast.splatinsert6, <2 x i64> poison, <2 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load5 = load <2 x i64>, ptr %1, align 8, !tbaa !4
  %2 = add nsw <2 x i64> %wide.load, %broadcast.splat
  %3 = add nsw <2 x i64> %wide.load5, %broadcast.splat7
  store <2 x i64> %2, ptr %0, align 8, !tbaa !4
  store <2 x i64> %3, ptr %1, align 8, !tbaa !4
...
attributes #0 = { argmemonly nofree norecurse nosync nounwind "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+64bit,+a,+c,+d,+f,+m,+relax,+v,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl128b,+zvl32b,+zvl64b,-save-restore" }
