...
vector.memcheck:                                  ; preds = %for.body.preheader
  ...
  %1 = sub i64 %c12, %b14
  %diff.check15 = icmp ult i64 %1, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load16 = load <16 x i8>, ptr %3, align 1, !tbaa !4
  %4 = getelementptr inbounds i8, ptr %b, i64 %index
  %wide.load17 = load <16 x i8>, ptr %4, align 1, !tbaa !4
  %5 = getelementptr inbounds i8, ptr %4, i64 16
  %wide.load18 = load <16 x i8>, ptr %5, align 1, !tbaa !4
  %6 = sub <16 x i8> %wide.load, %wide.load17
  %7 = sub <16 x i8> %wide.load16, %wide.load18
  %8 = tail call <16 x i8> @llvm.abs.v16i8(<16 x i8> %6, i1 false)
  %9 = tail call <16 x i8> @llvm.abs.v16i8(<16 x i8> %7, i1 false)
  %10 = getelementptr inbounds i8, ptr %c, i64 %index
  store <16 x i8> %8, ptr %10, align 1, !tbaa !4
  %11 = getelementptr inbounds i8, ptr %10, i64 16
  store <16 x i8> %9, ptr %11, align 1, !tbaa !4
