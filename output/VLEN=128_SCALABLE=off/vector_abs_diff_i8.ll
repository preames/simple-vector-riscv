...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check16 = icmp ult i32 %N, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load17 = load <16 x i8>, ptr %3, align 1, !tbaa !4
  %4 = getelementptr inbounds i8, ptr %b, i64 %index
  %wide.load18 = load <16 x i8>, ptr %4, align 1, !tbaa !4
  %5 = getelementptr inbounds i8, ptr %4, i64 16
  %wide.load19 = load <16 x i8>, ptr %5, align 1, !tbaa !4
  %6 = sub <16 x i8> %wide.load, %wide.load18
  %7 = sub <16 x i8> %wide.load17, %wide.load19
  %8 = call <16 x i8> @llvm.abs.v16i8(<16 x i8> %6, i1 false)
  %9 = call <16 x i8> @llvm.abs.v16i8(<16 x i8> %7, i1 false)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load24 = load <8 x i8>, ptr %13, align 1, !tbaa !4
  %14 = getelementptr inbounds i8, ptr %b, i64 %offset.idx
  %wide.load25 = load <8 x i8>, ptr %14, align 1, !tbaa !4
  %15 = sub <8 x i8> %wide.load24, %wide.load25
  %16 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %15, i1 false)
  %17 = getelementptr inbounds i8, ptr %c, i64 %offset.idx
  store <8 x i8> %16, ptr %17, align 1, !tbaa !4
  %index.next26 = add nuw i64 %offset.idx, 8
