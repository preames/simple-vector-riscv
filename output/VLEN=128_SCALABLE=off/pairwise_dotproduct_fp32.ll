...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <4 x float> @llvm.masked.gather.v4f32.v4p0(<4 x ptr> %10, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x float> undef), !tbaa !4, !alias.scope !8
  %11 = getelementptr inbounds float, ptr %c, <4 x i64> %vec.ind
  %wide.masked.gather33 = tail call <4 x float> @llvm.masked.gather.v4f32.v4p0(<4 x ptr> %11, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x float> undef), !tbaa !4, !alias.scope !11
  %12 = or <4 x i64> %vec.ind, <i64 1, i64 1, i64 1, i64 1>
  %13 = getelementptr inbounds float, ptr %b, <4 x i64> %12
  %wide.masked.gather34 = tail call <4 x float> @llvm.masked.gather.v4f32.v4p0(<4 x ptr> %13, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x float> undef), !tbaa !4, !alias.scope !8
  %14 = getelementptr inbounds float, ptr %c, <4 x i64> %12
  %wide.masked.gather35 = tail call <4 x float> @llvm.masked.gather.v4f32.v4p0(<4 x ptr> %14, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x float> undef), !tbaa !4, !alias.scope !11
