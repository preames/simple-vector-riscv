...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <4 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %2, %vector.body ]
  %vec.phi13 = phi <4 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %3, %vector.body ]
  %0 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <4 x i32>, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load14 = load <4 x i32>, ptr %1, align 4, !tbaa !4
  %2 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %wide.load, <4 x i32> %vec.phi)
  %3 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %wide.load14, <4 x i32> %vec.phi13)
