...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <4 x i32> @llvm.masked.gather.v4i32.v4p0(<4 x ptr> %0, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i32> poison), !tbaa !4
  %wide.masked.gather9 = tail call <4 x i32> @llvm.masked.gather.v4i32.v4p0(<4 x ptr> %1, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i32> poison), !tbaa !4
  %2 = add <4 x i32> %wide.masked.gather, %vec.phi
  %3 = add <4 x i32> %wide.masked.gather9, %vec.phi8
