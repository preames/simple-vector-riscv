...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %broadcast.splat, <8 x float> %wide.load11, <8 x float> %wide.load13)
...
for.body:                                         ; preds = %for.body.preheader14, %for.body
  %i.09 = phi i64 [ %inc, %for.body ], [ %i.09.ph, %for.body.preheader14 ]
