...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  tail call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> zeroinitializer, <4 x ptr> %0, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>), !tbaa !4
  tail call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> zeroinitializer, <4 x ptr> %1, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>), !tbaa !4
...
declare void @llvm.masked.scatter.v4i32.v4p0(<4 x i32>, <4 x ptr>, i32 immarg, <4 x i1>) #1
