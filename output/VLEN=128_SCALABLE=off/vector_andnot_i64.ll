...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %1, align 8, !tbaa !4, !alias.scope !8, !noalias !11
  %2 = getelementptr inbounds i64, ptr %1, i64 2
  %wide.load13 = load <2 x i64>, ptr %2, align 8, !tbaa !4, !alias.scope !8, !noalias !11
  %3 = getelementptr inbounds i64, ptr %b, i64 %index
  %wide.load14 = load <2 x i64>, ptr %3, align 8, !tbaa !4, !alias.scope !11
  %4 = getelementptr inbounds i64, ptr %3, i64 2
  %wide.load15 = load <2 x i64>, ptr %4, align 8, !tbaa !4, !alias.scope !11
  %5 = xor <2 x i64> %wide.load14, <i64 -1, i64 -1>
  %6 = xor <2 x i64> %wide.load15, <i64 -1, i64 -1>
  %7 = and <2 x i64> %wide.load, %5
  %8 = and <2 x i64> %wide.load13, %6
  store <2 x i64> %7, ptr %1, align 8, !tbaa !4, !alias.scope !8, !noalias !11
  store <2 x i64> %8, ptr %2, align 8, !tbaa !4, !alias.scope !8, !noalias !11
