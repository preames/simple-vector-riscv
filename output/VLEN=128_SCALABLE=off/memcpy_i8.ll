...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %1, align 1, !tbaa !4
  %2 = getelementptr inbounds i8, ptr %1, i64 16
  %wide.load11 = load <16 x i8>, ptr %2, align 1, !tbaa !4
  %3 = getelementptr inbounds i8, ptr %a, i64 %index
  store <16 x i8> %wide.load, ptr %3, align 1, !tbaa !4
  %4 = getelementptr inbounds i8, ptr %3, i64 16
  store <16 x i8> %wide.load11, ptr %4, align 1, !tbaa !4
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec13 = and i64 %wide.trip.count, 4294967288
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load16 = load <8 x i8>, ptr %6, align 1, !tbaa !4
  %7 = getelementptr inbounds i8, ptr %a, i64 %offset.idx
  store <8 x i8> %wide.load16, ptr %7, align 1, !tbaa !4
  %index.next17 = add nuw i64 %offset.idx, 8
