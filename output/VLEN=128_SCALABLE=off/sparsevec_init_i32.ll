...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load9 = load <4 x i16>, ptr %1, align 2, !tbaa !4
  %2 = sext <4 x i16> %wide.load to <4 x i64>
  %3 = sext <4 x i16> %wide.load9 to <4 x i64>
  %4 = getelementptr inbounds i32, ptr %a, <4 x i64> %2
  %5 = getelementptr inbounds i32, ptr %a, <4 x i64> %3
  tail call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> %vec.ind, <4 x ptr> %4, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>), !tbaa !8
  tail call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> %step.add, <4 x ptr> %5, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>), !tbaa !8
