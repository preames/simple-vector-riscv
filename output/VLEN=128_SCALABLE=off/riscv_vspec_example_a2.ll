...
vector.memcheck:                                  ; preds = %for.body.preheader
  ...
  %1 = sub i64 %b15, %c17
  %diff.check18 = icmp ult i64 %1, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load19 = load <16 x i8>, ptr %3, align 1, !tbaa !4
  %4 = icmp ult <16 x i8> %wide.load, <i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5>
  %5 = icmp ult <16 x i8> %wide.load19, <i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5>
  %6 = getelementptr i8, ptr %c, i64 %index
  %wide.masked.load = tail call <16 x i8> @llvm.masked.load.v16i8.p0(ptr %6, i32 1, <16 x i1> %4, <16 x i8> poison), !tbaa !4
  %7 = getelementptr i8, ptr %6, i64 16
  %wide.masked.load20 = tail call <16 x i8> @llvm.masked.load.v16i8.p0(ptr %7, i32 1, <16 x i1> %5, <16 x i8> poison), !tbaa !4
  %predphi = select <16 x i1> %4, <16 x i8> %wide.masked.load, <16 x i8> <i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1>
  %predphi21 = select <16 x i1> %5, <16 x i8> %wide.masked.load20, <16 x i8> <i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1>
  %8 = getelementptr inbounds i8, ptr %b, i64 %index
  store <16 x i8> %predphi, ptr %8, align 1, !tbaa !4
  %9 = getelementptr inbounds i8, ptr %8, i64 16
  store <16 x i8> %predphi21, ptr %9, align 1, !tbaa !4
