...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %v, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert5 = insertelement <4 x i32> poison, i32 %v, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  store <4 x i32> %broadcast.splat6, ptr %1, align 4, !tbaa !4
