...
.LBB0_7:
	...
	addi	a7, a4, %lo(.L__const.encode_byte_table.table)
	mv	a4, a6
	mv	a5, a0
.LBB0_8:
	addi	t0, a5, 8
	...
	vluxei64.v	v12, (a7), v8
	vsetvli	zero, zero, e64, m4, ta, ma
	vadd.vv	v8, v16, v16
	vsetvli	zero, zero, e16, m1, ta, ma
	vluxei64.v	v13, (a7), v8
	addi	t0, a2, 16
...
.LBB1_7:
	...
	addi	a7, a4, %lo(.L__const.encode_nibble_table.table)
	mv	a4, a6
	mv	a5, a0
.LBB1_8:
	...
	vluxei64.v	v9, (a7), v10
	vsetvli	zero, zero, e64, m2, ta, ma
	vzext.vf8	v10, v8
	vadd.vv	v10, v10, v10
	vsetvli	zero, zero, e16, mf2, ta, ma
	vluxei64.v	v8, (a7), v10
