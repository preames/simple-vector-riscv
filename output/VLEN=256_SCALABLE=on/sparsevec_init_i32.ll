...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %vec.ind, <8 x ptr> %4, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>), !tbaa !8
  call void @llvm.masked.scatter.v8i32.v8p0(<8 x i32> %step.add, <8 x ptr> %5, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>), !tbaa !8
