...
.LBB0_2:                                # %if.end
	...
	#DEBUG_VALUE: my_strcmp:a <- [DW_OP_LLVM_arg 0, DW_OP_consts 1, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_minus, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_stack_value] undef
	#DEBUG_VALUE: my_strcmp:b <- [DW_OP_constu 1, DW_OP_minus, DW_OP_stack_value] $x11
...
# %bb.3:                                # %if.end11
	...
	#DEBUG_VALUE: my_strcmp:b <- [DW_OP_constu 1, DW_OP_minus, DW_OP_stack_value] $x11
	#DEBUG_VALUE: my_strcmp:a <- [DW_OP_LLVM_arg 0, DW_OP_consts 1, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_minus, DW_OP_consts 1, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	#DEBUG_VALUE: my_strcmp:b <- $x11
	.loc	0 5 15                          # strcmp.c:5:15
	lbu	a3, 0(a1)
	.loc	0 5 12 is_stmt 0                # strcmp.c:5:12
	addi	a1, a1, 1
.Ltmp4:
