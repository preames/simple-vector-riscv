...
.LBB0_3:                                # %for.inc.7
	...
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 7, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_consts 18446744073709551608, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 8, DW_OP_plus, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
...
.LBB0_4:                                # %for.body
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_consts 18446744073709551608, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
...
# %bb.5:                                # %if.then
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	.loc	0 10 15 is_stmt 1               # lemire-20220714.c:10:15
	addi	t0, a1, 1
.Ltmp7:
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x5
	.loc	0 10 7 is_stmt 0                # lemire-20220714.c:10:7
	sh2add	t1, a1, a2
	mv	a1, t0
.Ltmp8:
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
...
.LBB0_6:                                # %for.inc
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 1, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
...
.LBB0_8:                                # %for.inc.1
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 2, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
	.loc	0 9 8 is_stmt 1                 # lemire-20220714.c:9:8
	lw	a3, -8(a5)
	.loc	0 9 17 is_stmt 0                # lemire-20220714.c:9:17
...
.LBB0_10:                               # %for.inc.2
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 3, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
	.loc	0 9 8 is_stmt 1                 # lemire-20220714.c:9:8
	lw	a3, -4(a5)
	.loc	0 9 17 is_stmt 0                # lemire-20220714.c:9:17
...
.LBB0_12:                               # %for.inc.3
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 4, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
	.loc	0 9 8 is_stmt 1                 # lemire-20220714.c:9:8
	lw	a3, 0(a5)
	.loc	0 9 17 is_stmt 0                # lemire-20220714.c:9:17
...
.LBB0_14:                               # %for.inc.4
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 5, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
	.loc	0 9 8 is_stmt 1                 # lemire-20220714.c:9:8
	lw	a3, 4(a5)
	.loc	0 9 17 is_stmt 0                # lemire-20220714.c:9:17
...
.LBB0_16:                               # %for.inc.5
	...
	#DEBUG_VALUE: remove_negatives_scalar:output <- $x12
	#DEBUG_VALUE: remove_negatives_scalar:input <- $x10
	#DEBUG_VALUE: remove_negatives_scalar:i <- [DW_OP_constu 6, DW_OP_or, DW_OP_stack_value] $x14
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x11
	.loc	0 9 8 is_stmt 1                 # lemire-20220714.c:9:8
	lw	a3, 8(a5)
	.loc	0 9 17 is_stmt 0                # lemire-20220714.c:9:17
...
# %bb.24:                               # %if.then.epil
	...
	addi	a4, a1, 1
.Ltmp45:
	#DEBUG_VALUE: remove_negatives_scalar:j <- $x14
	.loc	0 10 7 is_stmt 0                # lemire-20220714.c:10:7
	sh2add	a5, a1, a2
	mv	a1, a4
.Ltmp46:
