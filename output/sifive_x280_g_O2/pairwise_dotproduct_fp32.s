...
.LBB0_4:                                # %for.body
	...
	flw	fa5, 0(a2)
	.loc	0 4 41                          # pairwise_dotproduct_fp32.c:4:41
	addi	a4, a4, 2
.Ltmp7:
	#DEBUG_VALUE: i <- $x14
	...
	fmul.s	fa5, fa5, fa4
	.loc	0 5 15 is_stmt 0                # pairwise_dotproduct_fp32.c:5:15
	flw	fa4, -4(a2)
	.loc	0 4 26 is_stmt 1                # pairwise_dotproduct_fp32.c:4:26
	addi	a2, a2, 8
	.loc	0 5 28                          # pairwise_dotproduct_fp32.c:5:28
	fmadd.s	fa5, fa4, fa3, fa5
	.loc	0 5 12 is_stmt 0                # pairwise_dotproduct_fp32.c:5:12
	fsw	fa5, 0(a1)
	.loc	0 4 26 is_stmt 1                # pairwise_dotproduct_fp32.c:4:26
	addi	a1, a1, 4
.Ltmp8:
...
.LBB0_9:                                # %vector.body
	...
	vlseg2e32.v	v8, (a5)
	.loc	0 5 8 is_stmt 0                 # pairwise_dotproduct_fp32.c:5:8
	andi	a0, t3, -4
