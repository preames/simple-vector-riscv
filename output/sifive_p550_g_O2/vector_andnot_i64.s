...
# %bb.2:
	...
	#DEBUG_VALUE: vector_andnot_i64:b <- $x11
	#DEBUG_VALUE: vector_andnot_i64:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_andnot_i64.c:0:3
	li	a2, 0
.Ltmp2:
...
.Ltmp4:
	...
	#DEBUG_VALUE: vector_andnot_i64:b <- $x11
	#DEBUG_VALUE: vector_andnot_i64:a <- $x10
	.loc	0 4 0                           # vector_andnot_i64.c:4
	zext.w	a2, a2
.Ltmp5:
	.loc	0 0 0 is_stmt 0                 # vector_andnot_i64.c:0:0
	li	a4, 0
	.loc	0 4 3                           # vector_andnot_i64.c:4:3
	addi	a5, a1, 32
	andi	a2, a2, -8
...
.LBB0_5:                                # %for.body
	...
	.loc	0 5 20 is_stmt 1                # vector_andnot_i64.c:5:20
	ld	t0, -32(a5)
.Ltmp7:
	.loc	0 4 3                           # vector_andnot_i64.c:4:3
	addi	a4, a4, -8
.Ltmp8:
	...
	ld	t3, -16(a3)
	ld	t4, -8(a3)
	.loc	0 5 17 is_stmt 0                # vector_andnot_i64.c:5:17
	andn	a2, t2, t0
