...
# %bb.0:                                # %entry
	...
	#DEBUG_VALUE: i <- 0
	.loc	0 4 3 prologue_end              # vector_add_i32.c:4:3
	beqz	a1, .LBB0_3
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_add_i32.c:0:3
	li	a1, 0
.Ltmp2:
...
.LBB0_3:                                # %for.cond.cleanup
	#DEBUG_VALUE: vector_add_i32:b <- $x12
	.loc	0 6 1 is_stmt 1                 # vector_add_i32.c:6:1
	ret
.Ltmp4:
...
.LBB0_5:                                # %for.body
	...
	.loc	0 5 10 is_stmt 1                # vector_add_i32.c:5:10
	lw	t0, -16(a1)
	lw	t1, -12(a1)
	lw	a3, -8(a1)
	lw	a5, -4(a1)
...
.LBB0_7:                                # %for.body.epil
	...
	sh2add	a0, a1, a0
.Ltmp19:
	.loc	0 5 10 is_stmt 0                # vector_add_i32.c:5:10
	lw	a1, 0(a0)
.Ltmp20:
	add	a1, a1, a2
	sw	a1, 0(a0)
...
.Ltmp21:
	...
	.loc	0 4 3 is_stmt 1                 # vector_add_i32.c:4:3
	beq	a6, a1, .LBB0_3
.Ltmp22:
...
.Ltmp33:
	...
	.loc	0 6 1                           # vector_add_i32.c:6:1
	ret
.Ltmp34:
.Lfunc_end0:
