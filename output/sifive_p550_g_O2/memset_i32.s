...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:                                # %entry
	#DEBUG_VALUE: my_memset:a <- $x10
	#DEBUG_VALUE: my_memset:a_len <- $x11
	#DEBUG_VALUE: my_memset:b <- $x12
	#DEBUG_VALUE: i <- 0
	.loc	0 4 3 prologue_end              # memset_i32.c:4:3
	beqz	a1, .LBB0_3
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: my_memset:a_len <- $x11
	#DEBUG_VALUE: my_memset:a <- $x10
	.loc	0 0 3 is_stmt 0                 # memset_i32.c:0:3
	li	a1, 0
.Ltmp2:
...
.LBB0_3:                                # %for.cond.cleanup
	#DEBUG_VALUE: my_memset:b <- $x12
	.loc	0 6 1 is_stmt 1                 # memset_i32.c:6:1
	ret
.Ltmp4:
...
.LBB0_5:                                # %for.body
	...
	.loc	0 5 10 is_stmt 1                # memset_i32.c:5:10
	sw	a2, -16(a1)
.Ltmp7:
...
.LBB0_7:                                # %for.body.epil
	...
	sh2add	a0, a1, a0
.Ltmp18:
	.loc	0 0 5 is_stmt 0                 # memset_i32.c:0:5
	li	a1, 1
.Ltmp19:
	...
	sw	a2, 0(a0)
.Ltmp20:
	.loc	0 4 3 is_stmt 1                 # memset_i32.c:4:3
	beq	a3, a1, .LBB0_3
.Ltmp21:
