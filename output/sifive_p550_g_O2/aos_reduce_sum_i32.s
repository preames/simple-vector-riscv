...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:                                # %entry
	#DEBUG_VALUE: aos_reduce_sum_i32:len <- $x10
	#DEBUG_VALUE: aos_reduce_sum_i32:a <- $x11
	#DEBUG_VALUE: aos_reduce_sum_i32:sum <- 0
	#DEBUG_VALUE: i <- 0
	.loc	0 18 3 prologue_end             # aos_reduce_sum_i32.c:18:3
	beqz	a0, .LBB0_4
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: aos_reduce_sum_i32:a <- $x11
	#DEBUG_VALUE: aos_reduce_sum_i32:len <- $x10
	.loc	0 0 3 is_stmt 0                 # aos_reduce_sum_i32.c:0:3
	li	a0, 0
.Ltmp2:
	li	t0, 0
...
.LBB0_3:                                # %for.cond.cleanup
	.loc	0 20 3 is_stmt 1                # aos_reduce_sum_i32.c:20:3
	sext.w	a0, t0
	ret
.LBB0_4:
.Ltmp4:
	...
	#DEBUG_VALUE: aos_reduce_sum_i32:a <- $x11
	#DEBUG_VALUE: aos_reduce_sum_i32:len <- $x10
	.loc	0 20 3                          # aos_reduce_sum_i32.c:20:3
	li	a0, 0
.Ltmp5:
	ret
.Ltmp6:
.LBB0_5:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: aos_reduce_sum_i32:a <- $x11
	#DEBUG_VALUE: aos_reduce_sum_i32:len <- $x10
	.loc	0 18 0                          # aos_reduce_sum_i32.c:18
	zext.w	a0, a0
.Ltmp7:
	.loc	0 0 0 is_stmt 0                 # aos_reduce_sum_i32.c:0:0
	li	a4, 0
	li	t0, 0
	.loc	0 18 3                          # aos_reduce_sum_i32.c:18:3
	andi	a0, a0, -8
...
.LBB0_6:                                # %for.body
	...
	#DEBUG_VALUE: aos_reduce_sum_i32:a <- $x11
	#DEBUG_VALUE: aos_reduce_sum_i32:sum <- $x5
	#DEBUG_VALUE: i <- [DW_OP_consts 18446744073709551608, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_stack_value] $x14
	.loc	0 19 17 is_stmt 1               # aos_reduce_sum_i32.c:19:17
	lw	a3, -224(a5)
	lw	a0, -168(a5)
.Ltmp9:
	#DEBUG_VALUE: aos_reduce_sum_i32:sum <- undef
...
.Ltmp11:
	...
	add	a3, a3, t0
.Ltmp12:
	#DEBUG_VALUE: aos_reduce_sum_i32:sum <- $x13
	...
	add	a0, a0, a2
	.loc	0 19 17 is_stmt 0               # aos_reduce_sum_i32.c:19:17
	lw	t2, 0(a5)
	.loc	0 19 9                          # aos_reduce_sum_i32.c:19:9
	add	t0, a0, a3
.Ltmp13:
...
.Ltmp15:
	...
	.loc	0 18 3 is_stmt 1                # aos_reduce_sum_i32.c:18:3
	addi	a5, a5, 448
.Ltmp16:
	.loc	0 19 9                          # aos_reduce_sum_i32.c:19:9
	add	a3, a3, t1
...
.Ltmp22:
	lw	a0, 48(a1)
	.loc	0 19 9 is_stmt 0                # aos_reduce_sum_i32.c:19:9
	add	t0, t0, a0
.Ltmp23:
	#DEBUG_VALUE: aos_reduce_sum_i32:sum <- $x5
	.loc	0 0 9                           # aos_reduce_sum_i32.c:0:9
	li	a0, 1
.Ltmp24:
...
.Ldebug_info_start0:
	...
	.byte	1                               # Abbrev [1] 0xc:0xb6 DW_TAG_compile_unit
	...
	.word	111                             # DW_AT_type
	.byte	8                               # Abbrev [8] 0x6f:0x4e DW_TAG_structure_type
	.byte	16                              # DW_AT_name
	...
	.byte	9                               # Abbrev [9] 0xb3:0x9 DW_TAG_member
	.byte	15                              # DW_AT_name
	.word	98                              # DW_AT_type
	.byte	0                               # DW_AT_decl_file
	...
	.byte	0                               # End Of Children Mark
	.byte	6                               # Abbrev [6] 0xbd:0x4 DW_TAG_base_type
	.byte	8                               # DW_AT_name
	.byte	5                               # DW_AT_encoding
