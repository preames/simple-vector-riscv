...
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "sparsevec_add_fp64.c" md5 0x006fad79c4bf56f429a919dad4979ef2
	.cfi_startproc
# %bb.0:                                # %entry
	...
	#DEBUG_VALUE: i <- 0
	.loc	0 7 3 prologue_end              # sparsevec_add_fp64.c:7:3
	beqz	a0, .LBB0_3
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: sparsevec_add_i32:a <- $x11
	#DEBUG_VALUE: sparsevec_add_i32:len <- $x10
	.loc	0 0 3 is_stmt 0                 # sparsevec_add_fp64.c:0:3
	li	a5, 0
	.loc	0 7 3                           # sparsevec_add_fp64.c:7:3
	bnez	a6, .LBB0_7
.Ltmp2:
.LBB0_3:                                # %for.cond.cleanup
	#DEBUG_VALUE: sparsevec_add_i32:b <- $x13
	#DEBUG_VALUE: sparsevec_add_i32:a <- $x11
	.loc	0 9 1 is_stmt 1                 # sparsevec_add_fp64.c:9:1
	ret
.Ltmp3:
.LBB0_4:                                # %for.body.preheader.new
	...
	.cfi_offset s2, -24
.Ltmp4:
	.loc	0 7 0                           # sparsevec_add_fp64.c:7
	zext.w	a0, a0
.Ltmp5:
	.loc	0 0 0 is_stmt 0                 # sparsevec_add_fp64.c:0:0
	li	t0, 0
	.loc	0 7 3                           # sparsevec_add_fp64.c:7:3
	addi	a5, a4, 16
	andi	a0, a0, -8
...
.LBB0_5:                                # %for.body
	...
	.loc	0 8 21 is_stmt 1                # sparsevec_add_fp64.c:8:21
	lw	t1, -16(a5)
	lw	t2, -12(a5)
	lw	t3, -8(a5)
	lw	t4, -4(a5)
.Ltmp7:
	...
	addi	t0, t0, -8
.Ltmp8:
	.loc	0 8 19                          # sparsevec_add_fp64.c:8:19
	sh3add	t1, t1, a3
	.loc	0 8 7 is_stmt 0                 # sparsevec_add_fp64.c:8:7
	lw	t5, -16(a0)
	lw	t6, -12(a0)
	lw	s0, -8(a0)
	lw	s2, -4(a0)
	.loc	0 8 5                           # sparsevec_add_fp64.c:8:5
	sh3add	s1, t5, a1
	sh3add	t5, s2, a1
	.loc	0 8 19                          # sparsevec_add_fp64.c:8:19
	fld	fa5, 0(t1)
	.loc	0 8 16                          # sparsevec_add_fp64.c:8:16
	fld	fa4, 0(s1)
	fadd.d	fa5, fa5, fa4
	fsd	fa5, 0(s1)
.Ltmp9:
...
.Ltmp10:
	...
	.loc	0 8 19                          # sparsevec_add_fp64.c:8:19
	sh3add	s1, t3, a3
	.loc	0 8 21                          # sparsevec_add_fp64.c:8:21
	lw	t3, 0(a5)
	lw	t1, 4(a5)
	lw	t2, 8(a5)
	.loc	0 8 19                          # sparsevec_add_fp64.c:8:19
	...
	.loc	0 8 5                           # sparsevec_add_fp64.c:8:5
	sh3add	s1, s0, a1
	.loc	0 8 7                           # sparsevec_add_fp64.c:8:7
	lw	s0, 0(a0)
	.loc	0 8 16                          # sparsevec_add_fp64.c:8:16
	fld	fa4, 0(s1)
	fadd.d	fa5, fa5, fa4
...
.Ltmp11:
	...
	lw	t4, 12(a5)
.Ltmp12:
	.loc	0 7 3 is_stmt 1                 # sparsevec_add_fp64.c:7:3
	addi	a5, a5, 32
.Ltmp13:
	.loc	0 8 19                          # sparsevec_add_fp64.c:8:19
	fld	fa5, 0(s1)
	.loc	0 8 16 is_stmt 0                # sparsevec_add_fp64.c:8:16
	fld	fa4, 0(t5)
	.loc	0 8 19                          # sparsevec_add_fp64.c:8:19
	sh3add	s1, t3, a3
	.loc	0 8 7                           # sparsevec_add_fp64.c:8:7
...
# %bb.8:                                # %for.body.epil.1
	...
	.loc	0 8 21                          # sparsevec_add_fp64.c:8:21
	lw	a4, 4(a0)
	.loc	0 8 19 is_stmt 0                # sparsevec_add_fp64.c:8:19
	sh3add	a4, a4, a3
	fld	fa5, 0(a4)
	.loc	0 8 7                           # sparsevec_add_fp64.c:8:7
	lw	a4, 4(a2)
...
.Ldebug_info_start0:
	...
	.byte	2                               # Abbrev [2] 0x2b:0x47 DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.word	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.byte	5                               # DW_AT_decl_line
	.word	127                             # DW_AT_type
	.byte	4                               # Abbrev [4] 0x52:0xa DW_TAG_formal_parameter
	.byte	1                               # DW_AT_location
	.byte	93
	.byte	10                              # DW_AT_name
	.byte	0                               # DW_AT_decl_file
	...
	.word	118                             # DW_AT_type
	.byte	3                               # Abbrev [3] 0x5c:0x9 DW_TAG_formal_parameter
	.byte	2                               # DW_AT_location
	.byte	11                              # DW_AT_name
	.byte	0                               # DW_AT_decl_file
	.byte	6                               # DW_AT_decl_line
	.word	127                             # DW_AT_type
	.byte	5                               # Abbrev [5] 0x65:0xc DW_TAG_lexical_block
	.byte	0                               # DW_AT_ranges
	.byte	6                               # Abbrev [6] 0x67:0x9 DW_TAG_variable
	...
	.byte	0                               # End Of Children Mark
	.byte	7                               # Abbrev [7] 0x72:0x4 DW_TAG_base_type
	.byte	5                               # DW_AT_name
	.byte	7                               # DW_AT_encoding
	.byte	4                               # DW_AT_byte_size
	.byte	8                               # Abbrev [8] 0x76:0x5 DW_TAG_pointer_type
	.word	123                             # DW_AT_type
	.byte	7                               # Abbrev [7] 0x7b:0x4 DW_TAG_base_type
	.byte	7                               # DW_AT_name
	.byte	4                               # DW_AT_encoding
	.byte	8                               # DW_AT_byte_size
	.byte	8                               # Abbrev [8] 0x7f:0x5 DW_TAG_pointer_type
	.word	132                             # DW_AT_type
	.byte	7                               # Abbrev [7] 0x84:0x4 DW_TAG_base_type
	.byte	9                               # DW_AT_name
...
.Linfo_string1:
	.asciz	"sparsevec_add_fp64.c"          # string offset=108
.Linfo_string2:
	.asciz	"/home/preames/benchmarking/simple-vector-riscv" # string offset=129
.Linfo_string3:
	.asciz	"sparsevec_add_i32"             # string offset=176
.Linfo_string4:
	.asciz	"len"                           # string offset=194
.Linfo_string5:
	.asciz	"unsigned int"                  # string offset=198
.Linfo_string6:
	.asciz	"a"                             # string offset=211
.Linfo_string7:
	.asciz	"double"                        # string offset=213
.Linfo_string8:
	.asciz	"aidx"                          # string offset=220
.Linfo_string9:
	.asciz	"int"                           # string offset=225
.Linfo_string10:
	.asciz	"b"                             # string offset=229
.Linfo_string11:
	.asciz	"bidx"                          # string offset=231
.Linfo_string12:
