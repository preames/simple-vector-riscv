...
# %bb.2:
	...
	#DEBUG_VALUE: vector_reduce_max_i32:a_len <- $x11
	#DEBUG_VALUE: vector_reduce_max_i32:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_reduce_max_i32.c:0:3
	li	a3, 0
	addiw	t0, a4, 1871
...
.LBB0_5:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: vector_reduce_max_i32:a_len <- $x11
	#DEBUG_VALUE: vector_reduce_max_i32:a <- $x10
	.loc	0 3 0                           # vector_reduce_max_i32.c:3
	zext.w	a1, a1
.Ltmp7:
	.loc	0 0 0 is_stmt 0                 # vector_reduce_max_i32.c:0:0
	li	a3, 0
	.loc	0 3 3                           # vector_reduce_max_i32.c:3:3
	addi	a4, a0, 16
	andi	a1, a1, -8
...
.LBB0_6:                                # %for.body
	...
	#DEBUG_VALUE: vector_reduce_max_i32:a <- $x10
	#DEBUG_VALUE: vector_reduce_max_i32:max <- $x5
	...
	lw	a5, -12(a4)
.Ltmp9:
	#DEBUG_VALUE: vector_reduce_max_i32:max <- undef
...
.Ltmp11:
	...
	max	a2, a2, t0
.Ltmp12:
	#DEBUG_VALUE: vector_reduce_max_i32:max <- $x12
	#DEBUG_VALUE: i <- [DW_OP_constu 1, DW_OP_or, DW_OP_stack_value] $x13
	.loc	0 4 12 is_stmt 0                # vector_reduce_max_i32.c:4:12
	lw	t2, 0(a4)
	lw	t3, 4(a4)
	.loc	0 4 11                          # vector_reduce_max_i32.c:4:11
	max	a1, a1, a5
...
.Ltmp15:
	...
	.loc	0 3 3 is_stmt 1                 # vector_reduce_max_i32.c:3:3
	addi	a4, a4, 32
.Ltmp16:
	.loc	0 4 11                          # vector_reduce_max_i32.c:4:11
	max	a5, t3, a5
	max	a5, a5, t0
.Ltmp17:
	#DEBUG_VALUE: vector_reduce_max_i32:max <- $x15
...
.Ltmp22:
	lw	a3, 0(a0)
.Ltmp23:
	.loc	0 4 11 is_stmt 0                # vector_reduce_max_i32.c:4:11
	max	t0, a3, t0
.Ltmp24:
	#DEBUG_VALUE: vector_reduce_max_i32:max <- $x5
