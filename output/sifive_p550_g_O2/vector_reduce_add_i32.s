...
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "vector_reduce_add_i32.c" md5 0x26bb130cde9748ce3aa28a53d5545264
	.cfi_startproc
# %bb.0:                                # %entry
	...
	#DEBUG_VALUE: i <- 0
	.loc	0 5 3 prologue_end              # vector_reduce_add_i32.c:5:3
	beqz	a1, .LBB0_4
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_reduce_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_reduce_add_i32:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_reduce_add_i32.c:0:3
	li	a1, 0
.Ltmp2:
	li	t0, 0
	.loc	0 5 3                           # vector_reduce_add_i32.c:5:3
	bnez	a6, .LBB0_8
.Ltmp3:
.LBB0_3:                                # %for.cond.cleanup
	.loc	0 7 3 is_stmt 1                 # vector_reduce_add_i32.c:7:3
	sext.w	a0, t0
	ret
.LBB0_4:
.Ltmp4:
	...
	#DEBUG_VALUE: vector_reduce_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_reduce_add_i32:a <- $x10
	.loc	0 7 3                           # vector_reduce_add_i32.c:7:3
	li	a0, 0
.Ltmp5:
	ret
.Ltmp6:
.LBB0_5:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: vector_reduce_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_reduce_add_i32:a <- $x10
	.loc	0 5 0                           # vector_reduce_add_i32.c:5
	zext.w	a5, a1
	li	a4, 0
	li	t0, 0
	.loc	0 5 3 is_stmt 0                 # vector_reduce_add_i32.c:5:3
	andi	a5, a5, -8
	addi	a1, a0, 16
.Ltmp7:
	neg	a7, a5
...
.LBB0_6:                                # %for.body
	...
	.loc	0 6 12 is_stmt 1                # vector_reduce_add_i32.c:6:12
	lw	a3, -16(a1)
	lw	a5, -12(a1)
.Ltmp9:
...
.Ltmp10:
	...
	addi	a4, a4, -8
.Ltmp11:
	.loc	0 6 9                           # vector_reduce_add_i32.c:6:9
	add	a3, a3, t0
.Ltmp12:
	#DEBUG_VALUE: vector_reduce_add_i32:sum <- $x13
	#DEBUG_VALUE: i <- [DW_OP_constu 1, DW_OP_or, DW_OP_stack_value] $x14
	.loc	0 6 12 is_stmt 0                # vector_reduce_add_i32.c:6:12
	lw	t2, 0(a1)
	.loc	0 6 9                           # vector_reduce_add_i32.c:6:9
	add	a2, a2, a5
	.loc	0 6 12                          # vector_reduce_add_i32.c:6:12
	lw	a5, 4(a1)
	.loc	0 6 9                           # vector_reduce_add_i32.c:6:9
	add	t0, a2, a3
.Ltmp13:
...
.Ltmp15:
	...
	.loc	0 5 3 is_stmt 1                 # vector_reduce_add_i32.c:5:3
	addi	a1, a1, 32
.Ltmp16:
	.loc	0 6 9                           # vector_reduce_add_i32.c:6:9
	add	a5, a5, t1
...
.Ltmp21:
	lw	a1, 0(a0)
.Ltmp22:
	.loc	0 6 9 is_stmt 0                 # vector_reduce_add_i32.c:6:9
	add	t0, t0, a1
.Ltmp23:
	#DEBUG_VALUE: vector_reduce_add_i32:sum <- $x5
	.loc	0 0 9                           # vector_reduce_add_i32.c:0:9
	li	a1, 1
.Ltmp24:
...
.Linfo_string1:
	.asciz	"vector_reduce_add_i32.c"       # string offset=108
.Linfo_string2:
	.asciz	"/home/preames/benchmarking/simple-vector-riscv" # string offset=132
.Linfo_string3:
	.asciz	"vector_reduce_add_i32"         # string offset=179
.Linfo_string4:
