...
# %bb.2:
	...
	#DEBUG_VALUE: dotproduct_fp32:a <- $x11
	#DEBUG_VALUE: dotproduct_fp32:len <- $x10
	.loc	0 0 3 is_stmt 0                 # dotproduct_fp32.c:0:3
	li	a3, 0
	fmv.w.x	fa0, zero
...
.LBB0_5:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: dotproduct_fp32:a <- $x11
	#DEBUG_VALUE: dotproduct_fp32:len <- $x10
	.loc	0 5 0                           # dotproduct_fp32.c:5
	zext.w	a0, a0
.Ltmp5:
	.loc	0 0 0 is_stmt 0                 # dotproduct_fp32.c:0:0
	fmv.w.x	fa0, zero
	li	a4, 0
	.loc	0 5 3                           # dotproduct_fp32.c:5:3
	andi	a0, a0, -8
...
.Ltmp7:
	...
	addi	a4, a4, -8
.Ltmp8:
	.loc	0 6 19                          # dotproduct_fp32.c:6:19
	flw	fa1, -16(a5)
	flw	ft0, -12(a5)
	flw	ft1, -8(a5)
	flw	ft2, -4(a5)
	.loc	0 6 9 is_stmt 0                 # dotproduct_fp32.c:6:9
	fmadd.s	fa5, fa5, fa1, fa0
.Ltmp9:
	#DEBUG_VALUE: dotproduct_fp32:res <- $f15_f
...
.Ltmp12:
	...
	flw	ft2, 12(a5)
.Ltmp13:
	.loc	0 5 3 is_stmt 1                 # dotproduct_fp32.c:5:3
	addi	a5, a5, 32
	addi	a3, a3, 32
.Ltmp14:
	.loc	0 6 9                           # dotproduct_fp32.c:6:9
...
.LBB0_8:                                # %for.body.epil
	...
	sh2add	a1, a3, a2
.Ltmp21:
	.loc	0 0 19                          # dotproduct_fp32.c:0:19
	li	a2, 1
.Ltmp22:
