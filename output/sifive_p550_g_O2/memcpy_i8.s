...
# %bb.2:
	...
	#DEBUG_VALUE: my_memcpy:a <- $x11
	#DEBUG_VALUE: my_memcpy:len <- $x10
	.loc	0 0 3 is_stmt 0                 # memcpy_i8.c:0:3
	li	a0, 0
.Ltmp2:
...
.Ltmp4:
	...
	#DEBUG_VALUE: my_memcpy:a <- $x11
	#DEBUG_VALUE: my_memcpy:len <- $x10
	.loc	0 4 0                           # memcpy_i8.c:4
	zext.w	a0, a0
.Ltmp5:
	.loc	0 0 0 is_stmt 0                 # memcpy_i8.c:0:0
	li	a4, 0
	.loc	0 4 3                           # memcpy_i8.c:4:3
	addi	a5, a1, 3
	andi	a0, a0, -8
...
.Ltmp9:
	...
	.loc	0 5 12 is_stmt 0                # memcpy_i8.c:5:12
	lbu	a0, -2(a3)
	.loc	0 5 10                          # memcpy_i8.c:5:10
	sb	a0, -2(a5)
.Ltmp10:
...
.LBB0_7:                                # %for.body.epil
	...
	add	a2, a2, a0
.Ltmp21:
	.loc	0 5 5 is_stmt 0                 # memcpy_i8.c:5:5
	add	a1, a1, a0
.Ltmp22:
	.loc	0 0 5                           # memcpy_i8.c:0:5
	li	a0, 1
.Ltmp23:
...
# %bb.8:                                # %for.body.epil.1
	...
	.loc	0 5 12                          # memcpy_i8.c:5:12
	lbu	a0, 1(a2)
	.loc	0 5 10 is_stmt 0                # memcpy_i8.c:5:10
	sb	a0, 1(a1)
	li	a0, 2
.Ltmp26:
