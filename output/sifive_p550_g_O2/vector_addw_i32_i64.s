...
# %bb.2:
	...
	#DEBUG_VALUE: test:a <- $x11
	#DEBUG_VALUE: test:c <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_addw_i32_i64.c:0:3
	li	a3, 0
.Ltmp2:
...
.Ltmp9:
	...
	lw	s3, -8(a3)
	lw	s2, -4(a3)
	.loc	0 4 24 is_stmt 0                # vector_addw_i32_i64.c:4:24
	add	t1, t1, t5
	add	t2, t2, t6
	add	t3, t3, s3
	add	t4, t4, s2
...
.Ltmp13:
	...
	lw	t4, 12(a5)
.Ltmp14:
	.loc	0 3 3 is_stmt 1                 # vector_addw_i32_i64.c:3:3
	addi	a5, a5, 32
.Ltmp15:
	.loc	0 4 32                          # vector_addw_i32_i64.c:4:32
	lw	s0, 0(a3)
...
.Ldebug_info_start0:
	...
	.byte	3                               # Abbrev [3] 0x2f:0x3c DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.word	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
