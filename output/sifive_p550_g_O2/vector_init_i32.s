...
# %bb.2:
	...
	#DEBUG_VALUE: vector_init_i32:a_len <- $x11
	#DEBUG_VALUE: vector_init_i32:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_init_i32.c:0:3
	li	a3, 0
	j	.LBB0_5
.Ltmp2:
.LBB0_3:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: vector_init_i32:a_len <- $x11
	#DEBUG_VALUE: vector_init_i32:a <- $x10
	.loc	0 4 0                           # vector_init_i32.c:4
	zext.w	a1, a1
.Ltmp3:
	.loc	0 0 0                           # vector_init_i32.c:0:0
	li	a4, 0
	li	a3, 0
...
# %bb.6:                                # %for.body.epil
	#DEBUG_VALUE: vector_init_i32:a <- $x10
	#DEBUG_VALUE: i <- $x13
	.loc	0 5 5                           # vector_init_i32.c:5:5
	sh2add	a0, a3, a0
.Ltmp17:
	.loc	0 0 5 is_stmt 0                 # vector_init_i32.c:0:5
	li	a1, 1
.Ltmp18:
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 1, DW_OP_stack_value] $x13
	.loc	0 5 10                          # vector_init_i32.c:5:10
	sw	a3, 0(a0)
.Ltmp19:
	.loc	0 4 3 is_stmt 1                 # vector_init_i32.c:4:3
	beq	a6, a1, .LBB0_13
.Ltmp20:
# %bb.7:                                # %for.body.epil.1
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 1, DW_OP_stack_value] $x13
	.loc	0 4 36 is_stmt 0                # vector_init_i32.c:4:36
	addi	a1, a3, 1
.Ltmp21:
	#DEBUG_VALUE: i <- $x11
	.loc	0 5 10 is_stmt 1                # vector_init_i32.c:5:10
	...
	li	a1, 2
.Ltmp22:
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 2, DW_OP_stack_value] $x13
	.loc	0 4 3                           # vector_init_i32.c:4:3
	beq	a6, a1, .LBB0_13
.Ltmp23:
...
.Ltmp24:
	...
	li	a1, 3
.Ltmp25:
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 3, DW_OP_stack_value] $x13
	.loc	0 4 3                           # vector_init_i32.c:4:3
	beq	a6, a1, .LBB0_13
.Ltmp26:
...
.Ltmp27:
	...
	li	a1, 4
.Ltmp28:
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 4, DW_OP_stack_value] $x13
	.loc	0 4 3                           # vector_init_i32.c:4:3
	beq	a6, a1, .LBB0_13
.Ltmp29:
...
.Ltmp30:
	...
	li	a1, 5
.Ltmp31:
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 5, DW_OP_stack_value] $x13
	.loc	0 4 3                           # vector_init_i32.c:4:3
	beq	a6, a1, .LBB0_13
.Ltmp32:
...
.Ltmp33:
	...
	li	a1, 6
.Ltmp34:
	#DEBUG_VALUE: i <- [DW_OP_plus_uconst 6, DW_OP_stack_value] $x13
	.loc	0 4 3                           # vector_init_i32.c:4:3
	beq	a6, a1, .LBB0_13
.Ltmp35:
...
.LBB0_13:                               # %for.cond.cleanup
	.loc	0 6 1                           # vector_init_i32.c:6:1
	ret
.Ltmp38:
.Lfunc_end0:
...
.Ldebug_info_start0:
	...
	.byte	1                               # Abbrev [1] 0xc:0x57 DW_TAG_compile_unit
	...
	.byte	0                               # DW_AT_low_pc
	.word	.Ltmp37-.Lfunc_begin0           # DW_AT_high_pc
	...
	.byte	0                               # End Of Children Mark
	.byte	6                               # Abbrev [6] 0x55:0x5 DW_TAG_pointer_type
	.word	90                              # DW_AT_type
...
.Linfo_string3:
	.asciz	"vector_init_i32"               # string offset=173
.Linfo_string4:
	.asciz	"a"                             # string offset=189
.Linfo_string5:
	.asciz	"int"                           # string offset=191
.Linfo_string6:
	.asciz	"a_len"                         # string offset=195
.Linfo_string7:
