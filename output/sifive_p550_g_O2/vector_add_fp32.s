...
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "vector_add_fp32.c" md5 0x4f893f0811e8d19fe21a406b9cea051a
	.cfi_startproc
# %bb.0:                                # %entry
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	#DEBUG_VALUE: vector_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_add_i32:b <- $f10_f
	#DEBUG_VALUE: i <- 0
	.loc	0 4 3 prologue_end              # vector_add_fp32.c:4:3
	beqz	a1, .LBB0_3
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_add_fp32.c:0:3
	li	a1, 0
.Ltmp2:
	.loc	0 4 3                           # vector_add_fp32.c:4:3
	bnez	a2, .LBB0_7
.Ltmp3:
.LBB0_3:                                # %for.cond.cleanup
	#DEBUG_VALUE: vector_add_i32:b <- $f10_f
	.loc	0 6 1 is_stmt 1                 # vector_add_fp32.c:6:1
	ret
.Ltmp4:
.LBB0_4:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: vector_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	.loc	0 4 0                           # vector_add_fp32.c:4
	zext.w	a4, a1
	li	a3, 0
	.loc	0 4 3 is_stmt 0                 # vector_add_fp32.c:4:3
	addi	a1, a0, 16
.Ltmp5:
	andi	a4, a4, -8
	neg	a4, a4
...
.LBB0_5:                                # %for.body
	...
	.loc	0 5 10 is_stmt 1                # vector_add_fp32.c:5:10
	flw	fa5, -16(a1)
	flw	fa4, -12(a1)
	flw	fa3, -8(a1)
	flw	fa2, -4(a1)
.Ltmp7:
	...
	addi	a3, a3, -8
.Ltmp8:
	.loc	0 5 10                          # vector_add_fp32.c:5:10
	fadd.s	fa5, fa0, fa5
	fadd.s	fa4, fa0, fa4
	fadd.s	fa3, fa0, fa3
	fadd.s	fa2, fa0, fa2
...
.LBB0_7:                                # %for.body.epil
	...
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	#DEBUG_VALUE: i <- $x11
	.loc	0 5 5                           # vector_add_fp32.c:5:5
	sh2add	a0, a1, a0
.Ltmp19:
	.loc	0 0 5 is_stmt 0                 # vector_add_fp32.c:0:5
	li	a1, 1
.Ltmp20:
	...
	fsw	fa5, 0(a0)
.Ltmp21:
	.loc	0 4 3 is_stmt 1                 # vector_add_fp32.c:4:3
	beq	a2, a1, .LBB0_3
.Ltmp22:
...
.Ltmp38:
	...
	.loc	0 6 1                           # vector_add_fp32.c:6:1
	ret
.Ltmp39:
.Lfunc_end0:
...
.Ldebug_info_start0:
	...
	.byte	1                               # Abbrev [1] 0xc:0x62 DW_TAG_compile_unit
	...
	.byte	2                               # Abbrev [2] 0x2b:0x35 DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.word	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.byte	3                               # DW_AT_decl_line
	.word	105                             # DW_AT_type
	.byte	4                               # Abbrev [4] 0x48:0xb DW_TAG_formal_parameter
	.byte	2                               # DW_AT_location
	.byte	144
	.byte	42
	.byte	8                               # DW_AT_name
	...
	.byte	3                               # DW_AT_decl_line
	.word	101                             # DW_AT_type
	.byte	5                               # Abbrev [5] 0x53:0xc DW_TAG_lexical_block
	.byte	0                               # DW_AT_ranges
	.byte	6                               # Abbrev [6] 0x55:0x9 DW_TAG_variable
	.byte	2                               # DW_AT_location
	.byte	9                               # DW_AT_name
	.byte	0                               # DW_AT_decl_file
	...
	.word	101                             # DW_AT_type
	.byte	8                               # Abbrev [8] 0x65:0x4 DW_TAG_base_type
	.byte	5                               # DW_AT_name
...
.Linfo_string1:
	.asciz	"vector_add_fp32.c"             # string offset=108
.Linfo_string2:
	.asciz	"/home/preames/benchmarking/simple-vector-riscv" # string offset=126
.Linfo_string3:
	.asciz	"vector_add_i32"                # string offset=173
.Linfo_string4:
	.asciz	"a"                             # string offset=188
.Linfo_string5:
	.asciz	"float"                         # string offset=190
.Linfo_string6:
	.asciz	"a_len"                         # string offset=196
.Linfo_string7:
	.asciz	"unsigned int"                  # string offset=202
.Linfo_string8:
	.asciz	"b"                             # string offset=215
.Linfo_string9:
