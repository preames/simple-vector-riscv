...
.LBB0_4:
	...
	#DEBUG_VALUE: sparsevec_reduce_add_i32:a <- $x11
	#DEBUG_VALUE: sparsevec_reduce_add_i32:len <- $x10
	.loc	0 8 3                           # sparsevec_reduce_add_i32.c:8:3
	li	a0, 0
.Ltmp5:
	ret
.Ltmp6:
.LBB0_5:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: sparsevec_reduce_add_i32:a <- $x11
	#DEBUG_VALUE: sparsevec_reduce_add_i32:len <- $x10
	.loc	0 6 0                           # sparsevec_reduce_add_i32.c:6
	zext.w	a3, a0
	li	a5, 0
	li	t0, 0
...
.LBB0_6:                                # %for.body
	...
	#DEBUG_VALUE: sparsevec_reduce_add_i32:aidx <- $x12
	#DEBUG_VALUE: sparsevec_reduce_add_i32:a <- $x11
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- $x5
	#DEBUG_VALUE: i <- [DW_OP_consts 18446744073709551608, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_stack_value] $x15
...
.Ltmp10:
	...
	lw	t1, 0(t1)
.Ltmp11:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- undef
	#DEBUG_VALUE: i <- [DW_OP_constu 2, DW_OP_or, DW_OP_stack_value] $x15
	lw	a3, 0(t2)
	.loc	0 7 9 is_stmt 0                 # sparsevec_reduce_add_i32.c:7:9
	add	t0, t0, t3
.Ltmp12:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- $x5
	#DEBUG_VALUE: i <- [DW_OP_constu 1, DW_OP_or, DW_OP_stack_value] $x15
	add	a3, a3, t1
...
.Ltmp13:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- $x5
	#DEBUG_VALUE: i <- [DW_OP_constu 3, DW_OP_or, DW_OP_stack_value] $x15
	.loc	0 7 14                          # sparsevec_reduce_add_i32.c:7:14
	lh	a3, 6(a0)
.Ltmp14:
	.loc	0 6 3 is_stmt 1                 # sparsevec_reduce_add_i32.c:6:3
	addi	a0, a0, 16
.Ltmp15:
	.loc	0 7 12                          # sparsevec_reduce_add_i32.c:7:12
	sh2add	a3, a3, a1
	lw	t2, 0(a4)
.Ltmp16:
	#DEBUG_VALUE: i <- [DW_OP_constu 4, DW_OP_or, DW_OP_stack_value] $x15
	sh2add	a4, t1, a1
	lw	a3, 0(a3)
	sh2add	t1, t3, a1
	sh2add	t3, t4, a1
...
.Ltmp17:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- undef
	#DEBUG_VALUE: i <- [DW_OP_constu 7, DW_OP_or, DW_OP_stack_value] $x15
	lw	t1, 0(t1)
	.loc	0 7 9 is_stmt 0                 # sparsevec_reduce_add_i32.c:7:9
	add	a4, a4, t2
.Ltmp18:
	#DEBUG_VALUE: i <- [DW_OP_constu 5, DW_OP_or, DW_OP_stack_value] $x15
	add	a3, a3, t3
	add	a4, a4, t1
	add	a4, a4, t0
.Ltmp19:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- $x14
	#DEBUG_VALUE: i <- [DW_OP_constu 6, DW_OP_or, DW_OP_stack_value] $x15
	add	t0, a3, a4
.Ltmp20:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- $x5
	#DEBUG_VALUE: i <- [DW_OP_consts 18446744073709551608, DW_OP_div, DW_OP_consts 8, DW_OP_mul, DW_OP_consts 8, DW_OP_plus, DW_OP_stack_value] $x15
	.loc	0 6 3 is_stmt 1                 # sparsevec_reduce_add_i32.c:6:3
	bne	a7, a5, .LBB0_6
.Ltmp21:
...
.Ltmp25:
	#DEBUG_VALUE: sparsevec_reduce_add_i32:res <- $x5
	.loc	0 0 9                           # sparsevec_reduce_add_i32.c:0:9
	li	a2, 1
.Ltmp26:
...
.Ldebug_info_start0:
	...
	.byte	2                               # Abbrev [2] 0x2b:0x41 DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.word	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.word	108                             # DW_AT_type
	.byte	6                               # Abbrev [6] 0x5f:0xc DW_TAG_lexical_block
	.byte	0                               # DW_AT_ranges
