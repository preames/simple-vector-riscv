...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:                                # %entry
	#DEBUG_VALUE: vector_splat_i32:a <- $x10
	#DEBUG_VALUE: vector_splat_i32:v <- $x11
	#DEBUG_VALUE: vector_splat_i32:a_len <- $x12
	#DEBUG_VALUE: i <- 0
	.loc	0 4 3 prologue_end              # vector_splat_i32.c:4:3
	beqz	a2, .LBB0_3
.Ltmp0:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_splat_i32:v <- $x11
	#DEBUG_VALUE: vector_splat_i32:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_splat_i32.c:0:3
	li	a2, 0
.Ltmp2:
...
.LBB0_3:                                # %for.cond.cleanup
	#DEBUG_VALUE: vector_splat_i32:v <- $x11
	.loc	0 6 1 is_stmt 1                 # vector_splat_i32.c:6:1
	ret
.Ltmp4:
.LBB0_4:                                # %for.body.preheader.new
	...
	#DEBUG_VALUE: vector_splat_i32:v <- $x11
	#DEBUG_VALUE: vector_splat_i32:a <- $x10
	.loc	0 4 0                           # vector_splat_i32.c:4
	zext.w	a5, a2
	li	a4, 0
...
.LBB0_5:                                # %for.body
	...
	.loc	0 5 10 is_stmt 1                # vector_splat_i32.c:5:10
	sw	a1, -16(a2)
.Ltmp7:
...
.LBB0_7:                                # %for.body.epil
	...
	sh2add	a0, a2, a0
.Ltmp18:
	.loc	0 0 5 is_stmt 0                 # vector_splat_i32.c:0:5
	li	a2, 1
.Ltmp19:
	...
	sw	a1, 0(a0)
.Ltmp20:
	.loc	0 4 3 is_stmt 1                 # vector_splat_i32.c:4:3
	beq	a3, a2, .LBB0_3
.Ltmp21:
...
.Ltmp37:
	...
	.loc	0 6 1                           # vector_splat_i32.c:6:1
	ret
.Ltmp38:
.Lfunc_end0:
