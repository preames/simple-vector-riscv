...
# %bb.1:                                # %for.body.preheader
	...
	#DEBUG_VALUE: dotproduct_i32:a <- $x11
	#DEBUG_VALUE: dotproduct_i32:len <- $x10
	.loc	0 5 26 is_stmt 0                # dotproduct_i32.c:5:26
	zext.w	a6, a0
.Ltmp1:
...
# %bb.2:
	...
	#DEBUG_VALUE: dotproduct_i32:b <- $x12
	#DEBUG_VALUE: dotproduct_i32:a <- $x11
	.loc	0 0 3                           # dotproduct_i32.c:0:3
	li	a7, 0
	li	a0, 0
	.loc	0 5 3                           # dotproduct_i32.c:5:3
	j	.LBB0_6
...
.LBB0_4:                                # %vector.body
	...
	vmacc.vv	v8, v12, v10
	.loc	0 5 34                          # dotproduct_i32.c:5:34
	add	a0, a0, a4
	bne	a3, a5, .LBB0_4
.Ltmp6:
# %bb.5:                                # %middle.block
...
.LBB0_7:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	#DEBUG_VALUE: dotproduct_i32:res <- $x10
	...
	.loc	0 6 19 is_stmt 0                # dotproduct_i32.c:6:19
	lw	a4, 0(a2)
	.loc	0 5 26 is_stmt 1                # dotproduct_i32.c:5:26
	addi	a5, a5, 4
...
.Ldebug_info_start0:
	...
	.byte	3                               # DW_AT_decl_line
	.word	115                             # DW_AT_type
	.byte	4                               # Abbrev [4] 0x51:0x9 DW_TAG_variable
