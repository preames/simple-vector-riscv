...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %3 = tail call <vscale x 2 x i64> @llvm.experimental.stepvector.nxv2i64()
  %4 = tail call i64 @llvm.vscale.i64()
  %5 = shl nuw nsw i64 %4, 1
  %.splatinsert = insertelement <vscale x 2 x i64> poison, i64 %5, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = getelementptr inbounds %struct.T, ptr %a, <vscale x 2 x i64> %vec.ind, i32 6
  tail call void @llvm.masked.scatter.nxv2i64.nxv2p0(<vscale x 2 x i64> zeroinitializer, <vscale x 2 x ptr> %8, i32 8, <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i64 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer)), !tbaa !4
