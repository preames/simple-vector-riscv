...
# %bb.1:                                # %for.body.preheader
	...
	#DEBUG_VALUE: aos_reduce_sum_i64:a <- $x11
	#DEBUG_VALUE: aos_reduce_sum_i64:len <- $x10
	.loc	0 17 26 is_stmt 0               # aos_reduce_sum_i64.c:17:26
	zext.w	a6, a0
.Ltmp1:
...
.LBB0_3:                                # %vector.body
	...
	vlse64.v	v10, (a4), a2
	.loc	0 17 34                         # aos_reduce_sum_i64.c:17:34
	sub	a3, a3, a0
...
.LBB0_5:
	...
	#DEBUG_VALUE: aos_reduce_sum_i64:sum <- 0
	#DEBUG_VALUE: aos_reduce_sum_i64:a <- $x11
	.loc	0 0 3                           # aos_reduce_sum_i64.c:0:3
	li	a7, 0
	li	a0, 0
.Ltmp7:
...
.LBB0_7:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	#DEBUG_VALUE: aos_reduce_sum_i64:sum <- $x10
	...
	ld	a3, 0(a1)
	.loc	0 17 26                         # aos_reduce_sum_i64.c:17:26
	addi	a1, a1, 56
	.loc	0 18 9                          # aos_reduce_sum_i64.c:18:9
	addw	a0, a0, a3
.Ltmp10:
