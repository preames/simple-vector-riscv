...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %2, %vector.body ]
  %vec.phi8 = phi <4 x i64> [ zeroinitializer, %vector.ph ], [ %3, %vector.body ]
  ...
  %wide.masked.gather = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> %0, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i64> poison), !tbaa !4
  %wide.masked.gather9 = tail call <4 x i64> @llvm.masked.gather.v4i64.v4p0(<4 x ptr> %1, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i64> poison), !tbaa !4
  %2 = add <4 x i64> %wide.masked.gather, %vec.phi
  %3 = add <4 x i64> %wide.masked.gather9, %vec.phi8
...
middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <4 x i64> %3, %2
  %5 = tail call i64 @llvm.vector.reduce.add.v4i64(<4 x i64> %bin.rdx)
