...
; Function Attrs: nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) vscale_range(4,1024)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %target, i64 %2
  %3 = getelementptr inbounds i8, ptr %source, i64 %index
  %wide.load = load <8 x i8>, ptr %3, align 1, !tbaa !4, !alias.scope !18
  ...
  %13 = or <8 x i32> %12, %10
  store <8 x i32> %13, ptr %next.gep, align 1, !alias.scope !21, !noalias !18
...
attributes #0 = { nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) vscale_range(4,1024) "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv64" "target-features"="+64bit,+a,+c,+d,+f,+m,+relax,+v,+zba,+zbb,+zbc,+zbs,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl128b,+zvl256b,+zvl32b,+zvl64b,-save-restore" }
