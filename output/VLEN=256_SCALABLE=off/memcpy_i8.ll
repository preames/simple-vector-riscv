...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec13 = and i64 %wide.trip.count, 4294967280
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load16 = load <16 x i8>, ptr %6, align 1, !tbaa !4
  %7 = getelementptr inbounds i8, ptr %a, i64 %offset.idx
  store <16 x i8> %wide.load16, ptr %7, align 1, !tbaa !4
  %index.next17 = add nuw i64 %offset.idx, 16
