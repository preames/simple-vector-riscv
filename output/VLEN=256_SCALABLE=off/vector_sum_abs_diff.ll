...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %3, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %4 = getelementptr inbounds i8, ptr %b, <8 x i64> %2
  %wide.masked.gather35 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %4, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %5 = sub <8 x i8> %wide.masked.gather, %wide.masked.gather35
  %6 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %5, i1 false)
  ...
  %wide.masked.gather36 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %9, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %10 = getelementptr inbounds i8, ptr %b, <8 x i64> %8
  %wide.masked.gather37 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %10, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %11 = sub <8 x i8> %wide.masked.gather36, %wide.masked.gather37
  %12 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %11, i1 false)
  ...
  %wide.masked.gather38 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %16, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %17 = getelementptr inbounds i8, ptr %b, <8 x i64> %15
  %wide.masked.gather39 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %17, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %18 = sub <8 x i8> %wide.masked.gather38, %wide.masked.gather39
  %19 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %18, i1 false)
  ...
  %wide.masked.gather40 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %23, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %24 = getelementptr inbounds i8, ptr %b, <8 x i64> %22
  %wide.masked.gather41 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %24, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %25 = sub <8 x i8> %wide.masked.gather40, %wide.masked.gather41
  %26 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %25, i1 false)
  ...
  %wide.masked.gather42 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %30, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %31 = getelementptr inbounds i8, ptr %b, <8 x i64> %29
  %wide.masked.gather43 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %31, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %32 = sub <8 x i8> %wide.masked.gather42, %wide.masked.gather43
  %33 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %32, i1 false)
  ...
  %wide.masked.gather44 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %37, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %38 = getelementptr inbounds i8, ptr %b, <8 x i64> %36
  %wide.masked.gather45 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %38, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %39 = sub <8 x i8> %wide.masked.gather44, %wide.masked.gather45
  %40 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %39, i1 false)
  ...
  %wide.masked.gather46 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %44, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %45 = getelementptr inbounds i8, ptr %b, <8 x i64> %43
  %wide.masked.gather47 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %45, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %46 = sub <8 x i8> %wide.masked.gather46, %wide.masked.gather47
  %47 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %46, i1 false)
  ...
  %wide.masked.gather48 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %51, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !7
  %52 = getelementptr inbounds i8, ptr %b, <8 x i64> %50
  %wide.masked.gather49 = call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %52, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> undef), !tbaa !4, !alias.scope !10
  %53 = sub <8 x i8> %wide.masked.gather48, %wide.masked.gather49
  %54 = call <8 x i8> @llvm.abs.v8i8(<8 x i8> %53, i1 false)
