...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) vscale_range(4,1024)
...
; Function Attrs: nofree nosync nounwind memory(argmem: readwrite) vscale_range(4,1024)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %3, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %4 = getelementptr inbounds i8, ptr %b, <8 x i64> %2
  %wide.masked.gather35 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %4, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather36 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %9, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %10 = getelementptr inbounds i8, ptr %b, <8 x i64> %8
  %wide.masked.gather37 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %10, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather38 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %16, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %17 = getelementptr inbounds i8, ptr %b, <8 x i64> %15
  %wide.masked.gather39 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %17, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather40 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %23, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %24 = getelementptr inbounds i8, ptr %b, <8 x i64> %22
  %wide.masked.gather41 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %24, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather42 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %30, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %31 = getelementptr inbounds i8, ptr %b, <8 x i64> %29
  %wide.masked.gather43 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %31, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather44 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %37, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %38 = getelementptr inbounds i8, ptr %b, <8 x i64> %36
  %wide.masked.gather45 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %38, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather46 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %44, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %45 = getelementptr inbounds i8, ptr %b, <8 x i64> %43
  %wide.masked.gather47 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %45, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
  ...
  %wide.masked.gather48 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %51, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !7
  %52 = getelementptr inbounds i8, ptr %b, <8 x i64> %50
  %wide.masked.gather49 = tail call <8 x i8> @llvm.masked.gather.v8i8.v8p0(<8 x ptr> %52, i32 1, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i8> poison), !tbaa !4, !alias.scope !10
...
attributes #0 = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) vscale_range(4,1024) "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv64" "target-features"="+64bit,+a,+c,+d,+f,+m,+relax,+v,+zba,+zbb,+zbc,+zbs,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl128b,+zvl256b,+zvl32b,+zvl64b,-save-restore" }
attributes #1 = { nofree nosync nounwind memory(argmem: readwrite) vscale_range(4,1024) "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv64" "target-features"="+64bit,+a,+c,+d,+f,+m,+relax,+v,+zba,+zbb,+zbc,+zbs,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl128b,+zvl256b,+zvl32b,+zvl64b,-save-restore" }
