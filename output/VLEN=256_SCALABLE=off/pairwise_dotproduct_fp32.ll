...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.ind = phi <8 x i64> [ <i64 0, i64 2, i64 4, i64 6, i64 8, i64 10, i64 12, i64 14>, %vector.ph ], [ %vec.ind.next, %vector.body ]
  %offset.idx = and i64 %index, 9223372036854775800
  %10 = getelementptr inbounds float, ptr %b, <8 x i64> %vec.ind
  %wide.masked.gather = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %10, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> poison), !tbaa !4, !alias.scope !8
  %11 = getelementptr inbounds float, ptr %c, <8 x i64> %vec.ind
  %wide.masked.gather33 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %11, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> poison), !tbaa !4, !alias.scope !11
  %12 = or <8 x i64> %vec.ind, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %13 = getelementptr inbounds float, ptr %b, <8 x i64> %12
  %wide.masked.gather34 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %13, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> poison), !tbaa !4, !alias.scope !8
  %14 = getelementptr inbounds float, ptr %c, <8 x i64> %12
  %wide.masked.gather35 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %14, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> poison), !tbaa !4, !alias.scope !11
  %15 = fmul <8 x float> %wide.masked.gather34, %wide.masked.gather35
  %16 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %wide.masked.gather, <8 x float> %wide.masked.gather33, <8 x float> %15)
  %17 = getelementptr inbounds float, ptr %a, i64 %offset.idx
  store <8 x float> %16, ptr %17, align 4, !tbaa !4, !alias.scope !13, !noalias !15
