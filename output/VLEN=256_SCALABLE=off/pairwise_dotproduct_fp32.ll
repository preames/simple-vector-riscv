...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %10, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef), !tbaa !4, !alias.scope !8
  %11 = getelementptr inbounds float, ptr %c, <8 x i64> %vec.ind
  %wide.masked.gather33 = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %11, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef), !tbaa !4, !alias.scope !11
  %12 = or <8 x i64> %vec.ind, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %13 = getelementptr inbounds float, ptr %b, <8 x i64> %12
  %wide.masked.gather34 = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %13, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef), !tbaa !4, !alias.scope !8
  %14 = getelementptr inbounds float, ptr %c, <8 x i64> %12
  %wide.masked.gather35 = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %14, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef), !tbaa !4, !alias.scope !11
  %15 = fmul <8 x float> %wide.masked.gather34, %wide.masked.gather35
  %16 = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %wide.masked.gather, <8 x float> %wide.masked.gather33, <8 x float> %15)
