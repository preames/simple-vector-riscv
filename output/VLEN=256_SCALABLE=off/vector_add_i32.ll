...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert6 = insertelement <8 x i32> poison, i32 %b, i64 0
  %broadcast.splat7 = shufflevector <8 x i32> %broadcast.splatinsert6, <8 x i32> poison, <8 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load5 = load <8 x i32>, ptr %1, align 4, !tbaa !4
  %2 = add nsw <8 x i32> %wide.load, %broadcast.splat
  %3 = add nsw <8 x i32> %wide.load5, %broadcast.splat7
  store <8 x i32> %2, ptr %0, align 4, !tbaa !4
  store <8 x i32> %3, ptr %1, align 4, !tbaa !4
