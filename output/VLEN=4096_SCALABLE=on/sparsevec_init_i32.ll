...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %3 = tail call <vscale x 4 x i32> @llvm.experimental.stepvector.nxv4i32()
  %4 = tail call i32 @llvm.vscale.i32()
  %5 = shl nuw nsw i32 %4, 2
  %.splatinsert = insertelement <vscale x 4 x i32> poison, i32 %5, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = getelementptr inbounds i16, ptr %aidx, i64 %index
  %wide.load = load <vscale x 4 x i16>, ptr %8, align 2, !tbaa !4
  %9 = sext <vscale x 4 x i16> %wide.load to <vscale x 4 x i64>
  %10 = getelementptr inbounds i32, ptr %a, <vscale x 4 x i64> %9
  tail call void @llvm.masked.scatter.nxv4i32.nxv4p0(<vscale x 4 x i32> %vec.ind, <vscale x 4 x ptr> %10, i32 4, <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)), !tbaa !8
...
for.body:                                         ; preds = %for.body.preheader8, %for.body
  ...
  store i32 %13, ptr %arrayidx2, align 4, !tbaa !8
