...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = getelementptr inbounds i16, ptr %aidx, i64 %index
  %wide.load = load <vscale x 4 x i16>, ptr %5, align 2, !tbaa !4
  %6 = sext <vscale x 4 x i16> %wide.load to <vscale x 4 x i64>
  %7 = getelementptr inbounds i32, ptr %a, <vscale x 4 x i64> %6
  %wide.masked.gather = tail call <vscale x 4 x i32> @llvm.masked.gather.nxv4i32.nxv4p0(<vscale x 4 x ptr> %7, i32 4, <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), <vscale x 4 x i32> poison), !tbaa !8
  %8 = add <vscale x 4 x i32> %wide.masked.gather, %vec.phi
...
for.body.preheader9:                              ; preds = %for.body.preheader, %middle.block
  ...
  %res.07.ph = phi i32 [ 0, %for.body.preheader ], [ %10, %middle.block ]
  br label %for.body

for.cond.cleanup:                                 ; preds = %for.body, %middle.block, %entry
  %res.0.lcssa = phi i32 [ 0, %entry ], [ %10, %middle.block ], [ %add, %for.body ]
  ret i32 %res.0.lcssa
...
for.body:                                         ; preds = %for.body.preheader9, %for.body
  ...
  %11 = load i16, ptr %arrayidx, align 2, !tbaa !4
  %idxprom1 = sext i16 %11 to i64
  %arrayidx2 = getelementptr inbounds i32, ptr %a, i64 %idxprom1
  %12 = load i32, ptr %arrayidx2, align 4, !tbaa !8
  %add = add nsw i32 %12, %res.07
