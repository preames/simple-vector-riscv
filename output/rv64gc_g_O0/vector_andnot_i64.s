...
.Lfunc_begin0:
	...
	.loc	0 3 0                           # vector_andnot_i64.c:3:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # vector_andnot_i64.c:4:17
	sw	a0, -40(s0)
	.loc	0 4 8 is_stmt 0                 # vector_andnot_i64.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # vector_andnot_i64.c:4:24
	lw	a0, -40(s0)
	.loc	0 4 28                          # vector_andnot_i64.c:4:28
	lw	a1, -36(s0)
.Ltmp2:
...
.Ltmp3:
	.loc	0 5 12 is_stmt 1                # vector_andnot_i64.c:5:12
	ld	a0, -24(s0)
	.loc	0 5 14 is_stmt 0                # vector_andnot_i64.c:5:14
	lwu	a1, -40(s0)
	.loc	0 5 12                          # vector_andnot_i64.c:5:12
	slli	a3, a1, 3
	add	a1, a0, a3
	ld	a0, 0(a1)
	.loc	0 5 20                          # vector_andnot_i64.c:5:20
	ld	a2, -32(s0)
	add	a2, a2, a3
	ld	a2, 0(a2)
	.loc	0 5 19                          # vector_andnot_i64.c:5:19
	not	a2, a2
	.loc	0 5 17                          # vector_andnot_i64.c:5:17
	and	a0, a0, a2
	.loc	0 5 10                          # vector_andnot_i64.c:5:10
	sd	a0, 0(a1)
	.loc	0 5 5                           # vector_andnot_i64.c:5:5
	j	.LBB0_3
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
...
.LBB0_4:                                # %for.end
	.cfi_def_cfa sp, 48
	.loc	0 6 1 epilogue_begin is_stmt 1  # vector_andnot_i64.c:6:1
