...
.Lfunc_begin0:
	...
	.loc	0 3 0                           # vector_add_i64.c:3:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # vector_add_i64.c:4:17
	sw	a0, -44(s0)
	.loc	0 4 8 is_stmt 0                 # vector_add_i64.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # vector_add_i64.c:4:24
	lw	a0, -44(s0)
	.loc	0 4 28                          # vector_add_i64.c:4:28
	lw	a1, -28(s0)
.Ltmp2:
...
.Ltmp3:
	.loc	0 5 13 is_stmt 1                # vector_add_i64.c:5:13
	ld	a2, -40(s0)
	.loc	0 5 5 is_stmt 0                 # vector_add_i64.c:5:5
	ld	a0, -24(s0)
	.loc	0 5 7                           # vector_add_i64.c:5:7
	lwu	a1, -44(s0)
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 4 36 is_stmt 1                # vector_add_i64.c:4:36
	lw	a0, -44(s0)
	addiw	a0, a0, 1
	sw	a0, -44(s0)
...
.LBB0_4:                                # %for.end
	.cfi_def_cfa sp, 48
	.loc	0 6 1 epilogue_begin is_stmt 1  # vector_add_i64.c:6:1
