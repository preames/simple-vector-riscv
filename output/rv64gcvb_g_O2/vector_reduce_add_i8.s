...
# %bb.1:                                # %for.body.preheader
	...
	#DEBUG_VALUE: vector_reduce_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_reduce_add_i32:a <- $x10
	.loc	0 5 26 is_stmt 0                # vector_reduce_add_i8.c:5:26
	zext.w	a2, a1
.Ltmp1:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_reduce_add_i32:sum <- 0
	#DEBUG_VALUE: vector_reduce_add_i32:a <- $x10
	.loc	0 0 3                           # vector_reduce_add_i8.c:0:3
	li	a3, 0
	li	a1, 0
	.loc	0 5 3                           # vector_reduce_add_i8.c:5:3
	j	.LBB0_6
...
.LBB0_4:                                # %vector.body
	...
	vle8.v	v10, (a5)
	.loc	0 5 36                          # vector_reduce_add_i8.c:5:36
	add	a5, a5, a1
	.loc	0 6 12                          # vector_reduce_add_i8.c:6:12
	vzext.vf2	v11, v10
	.loc	0 6 9 is_stmt 0                 # vector_reduce_add_i8.c:6:9
	vwaddu.wv	v8, v8, v11
	.loc	0 5 36 is_stmt 1                # vector_reduce_add_i8.c:5:36
	bne	a5, a4, .LBB0_4
.Ltmp6:
# %bb.5:                                # %middle.block
	#DEBUG_VALUE: i <- 0
...
.LBB0_7:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	#DEBUG_VALUE: vector_reduce_add_i32:sum <- $x11
	...
	.loc	0 6 12 is_stmt 1                # vector_reduce_add_i8.c:6:12
	lbu	a2, 0(a3)
	.loc	0 5 26                          # vector_reduce_add_i8.c:5:26
	addi	a3, a3, 1
...
.Ldebug_info_start0:
	...
	.word	98                              # DW_AT_type
	.byte	5                               # Abbrev [5] 0x51:0x10 DW_TAG_lexical_block
	.byte	0                               # DW_AT_low_pc
	.word	.Ltmp10-.Lfunc_begin0           # DW_AT_high_pc
