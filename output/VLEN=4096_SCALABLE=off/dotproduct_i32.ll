...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load11 = load <128 x i32>, ptr %1, align 4, !tbaa !4
  %2 = getelementptr inbounds i32, ptr %b, i64 %index
  %wide.load12 = load <128 x i32>, ptr %2, align 4, !tbaa !4
  %3 = getelementptr inbounds i32, ptr %2, i64 128
  %wide.load13 = load <128 x i32>, ptr %3, align 4, !tbaa !4
  %4 = mul nsw <128 x i32> %wide.load12, %wide.load
  %5 = mul nsw <128 x i32> %wide.load13, %wide.load11
  %6 = add <128 x i32> %4, %vec.phi
  %7 = add <128 x i32> %5, %vec.phi10
