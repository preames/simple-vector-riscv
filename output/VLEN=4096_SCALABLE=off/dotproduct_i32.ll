...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check10 = icmp ult i32 %len, 256
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi11 = phi <128 x i32> [ zeroinitializer, %vector.ph ], [ %7, %vector.body ]
  %0 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <128 x i32>, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 128
  %wide.load12 = load <128 x i32>, ptr %1, align 4, !tbaa !4
  %2 = getelementptr inbounds i32, ptr %b, i64 %index
  %wide.load13 = load <128 x i32>, ptr %2, align 4, !tbaa !4
  %3 = getelementptr inbounds i32, ptr %2, i64 128
  %wide.load14 = load <128 x i32>, ptr %3, align 4, !tbaa !4
  %4 = mul nsw <128 x i32> %wide.load13, %wide.load
  %5 = mul nsw <128 x i32> %wide.load14, %wide.load12
  %6 = add <128 x i32> %4, %vec.phi
  %7 = add <128 x i32> %5, %vec.phi11
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec16 = and i64 %wide.trip.count, 4294967232
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.phi19 = phi <64 x i32> [ %10, %vec.epilog.ph ], [ %14, %vec.epilog.vector.body ]
  %11 = getelementptr inbounds i32, ptr %a, i64 %offset.idx
  %wide.load20 = load <64 x i32>, ptr %11, align 4, !tbaa !4
  %12 = getelementptr inbounds i32, ptr %b, i64 %offset.idx
  %wide.load21 = load <64 x i32>, ptr %12, align 4, !tbaa !4
  %13 = mul nsw <64 x i32> %wide.load21, %wide.load20
  %14 = add <64 x i32> %13, %vec.phi19
