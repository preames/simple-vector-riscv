...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi9 = phi <128 x i32> [ zeroinitializer, %vector.ph ], [ %7, %vector.body ]
  ...
  %wide.load10 = load <128 x i16>, ptr %1, align 2, !tbaa !4
  %2 = sext <128 x i16> %wide.load to <128 x i64>
  %3 = sext <128 x i16> %wide.load10 to <128 x i64>
