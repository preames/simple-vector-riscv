...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check5 = icmp ult i32 %a_len, 256
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %broadcast.splatinsert7 = insertelement <128 x i32> poison, i32 %b, i64 0
  %broadcast.splat8 = shufflevector <128 x i32> %broadcast.splatinsert7, <128 x i32> poison, <128 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load6 = load <128 x i32>, ptr %1, align 4, !tbaa !4
  %2 = add nsw <128 x i32> %wide.load, %broadcast.splat
  %3 = add nsw <128 x i32> %wide.load6, %broadcast.splat8
  store <128 x i32> %2, ptr %0, align 4, !tbaa !4
  store <128 x i32> %3, ptr %1, align 4, !tbaa !4
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec10 = and i64 %wide.trip.count, 4294967232
  %broadcast.splatinsert14 = insertelement <64 x i32> poison, i32 %b, i64 0
  %broadcast.splat15 = shufflevector <64 x i32> %broadcast.splatinsert14, <64 x i32> poison, <64 x i32> zeroinitializer
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load13 = load <64 x i32>, ptr %5, align 4, !tbaa !4
  %6 = add nsw <64 x i32> %wide.load13, %broadcast.splat15
  store <64 x i32> %6, ptr %5, align 4, !tbaa !4
