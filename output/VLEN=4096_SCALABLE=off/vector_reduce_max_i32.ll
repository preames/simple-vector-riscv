...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %2 = call <128 x i32> @llvm.smax.v128i32(<128 x i32> %wide.load, <128 x i32> %vec.phi)
  %3 = call <128 x i32> @llvm.smax.v128i32(<128 x i32> %wide.load15, <128 x i32> %vec.phi14)
  %index.next = add nuw i64 %index, 256
  %4 = icmp eq i64 %index.next, %n.vec
  br i1 %4, label %middle.block, label %vector.body, !llvm.loop !8

middle.block:                                     ; preds = %vector.body
  %5 = call <128 x i32> @llvm.smax.v128i32(<128 x i32> %2, <128 x i32> %3)
  %6 = call i32 @llvm.vector.reduce.smax.v128i32(<128 x i32> %5)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %8 = call <64 x i32> @llvm.smax.v64i32(<64 x i32> %wide.load21, <64 x i32> %vec.phi20)
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %10 = call i32 @llvm.vector.reduce.smax.v64i32(<64 x i32> %8)
