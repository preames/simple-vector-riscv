...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = call <512 x i8> @llvm.abs.v512i8(<512 x i8> %6, i1 false)
  %9 = call <512 x i8> @llvm.abs.v512i8(<512 x i8> %7, i1 false)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %16 = call <256 x i8> @llvm.abs.v256i8(<256 x i8> %15, i1 false)
