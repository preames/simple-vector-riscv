...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load16 = load <512 x i8>, ptr %3, align 1, !tbaa !4
  %4 = getelementptr inbounds i8, ptr %b, i64 %index
  %wide.load17 = load <512 x i8>, ptr %4, align 1, !tbaa !4
  %5 = getelementptr inbounds i8, ptr %4, i64 512
  %wide.load18 = load <512 x i8>, ptr %5, align 1, !tbaa !4
  %6 = sub <512 x i8> %wide.load, %wide.load17
  %7 = sub <512 x i8> %wide.load16, %wide.load18
