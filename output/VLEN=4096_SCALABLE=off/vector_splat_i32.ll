...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %broadcast.splatinsert = insertelement <128 x i32> poison, i32 %v, i64 0
  %broadcast.splat = shufflevector <128 x i32> %broadcast.splatinsert, <128 x i32> poison, <128 x i32> zeroinitializer
  %broadcast.splatinsert6 = insertelement <128 x i32> poison, i32 %v, i64 0
  %broadcast.splat7 = shufflevector <128 x i32> %broadcast.splatinsert6, <128 x i32> poison, <128 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <128 x i32> %broadcast.splat7, ptr %1, align 4, !tbaa !4
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec9 = and i64 %wide.trip.count, 4294967232
  %broadcast.splatinsert12 = insertelement <64 x i32> poison, i32 %v, i64 0
  %broadcast.splat13 = shufflevector <64 x i32> %broadcast.splatinsert12, <64 x i32> poison, <64 x i32> zeroinitializer
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <64 x i32> %broadcast.splat13, ptr %3, align 4, !tbaa !4
  %index.next14 = add nuw i64 %offset.idx, 64
