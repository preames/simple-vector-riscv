...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi7 = phi <128 x i32> [ zeroinitializer, %vector.ph ], [ %5, %vector.body ]
  ...
  %wide.load8 = load <128 x i8>, ptr %1, align 1, !tbaa !4
  %2 = zext <128 x i8> %wide.load to <128 x i32>
  %3 = zext <128 x i8> %wide.load8 to <128 x i32>
  %4 = add <128 x i32> %vec.phi, %2
  %5 = add <128 x i32> %vec.phi7, %3
...
middle.block:                                     ; preds = %vector.body
  ...
  %7 = tail call i32 @llvm.vector.reduce.add.v128i32(<128 x i32> %bin.rdx)
