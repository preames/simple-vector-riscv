...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = tail call <128 x float> @llvm.fmuladd.v128f32(<128 x float> %broadcast.splat, <128 x float> %wide.load, <128 x float> %wide.load13)
  %6 = tail call <128 x float> @llvm.fmuladd.v128f32(<128 x float> %broadcast.splat16, <128 x float> %wide.load12, <128 x float> %wide.load14)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %10 = tail call <64 x float> @llvm.fmuladd.v64f32(<64 x float> %broadcast.splat24, <64 x float> %wide.load21, <64 x float> %wide.load22)
