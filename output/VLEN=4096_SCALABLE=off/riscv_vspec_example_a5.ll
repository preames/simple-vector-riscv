...
for.body.preheader:                               ; preds = %entry
  %min.iters.check = icmp ult i64 %n, 256
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %broadcast.splatinsert14 = insertelement <128 x float> poison, float %a, i64 0
  %broadcast.splat15 = shufflevector <128 x float> %broadcast.splatinsert14, <128 x float> poison, <128 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load11 = load <128 x float>, ptr %2, align 4, !tbaa !4, !alias.scope !8
  %3 = getelementptr inbounds float, ptr %y, i64 %index
  %wide.load12 = load <128 x float>, ptr %3, align 4, !tbaa !4, !alias.scope !11, !noalias !8
  %4 = getelementptr inbounds float, ptr %3, i64 128
  %wide.load13 = load <128 x float>, ptr %4, align 4, !tbaa !4, !alias.scope !11, !noalias !8
  %5 = tail call <128 x float> @llvm.fmuladd.v128f32(<128 x float> %broadcast.splat, <128 x float> %wide.load, <128 x float> %wide.load12)
  %6 = tail call <128 x float> @llvm.fmuladd.v128f32(<128 x float> %broadcast.splat15, <128 x float> %wide.load11, <128 x float> %wide.load13)
