...
# %bb.1:                                # %for.body.preheader
	...
	#DEBUG_VALUE: vector_overlap:b <- $x11
	#DEBUG_VALUE: vector_overlap:a <- $x10
	.loc	0 7 21 is_stmt 0                # vector_overlap_i32.c:7:21
	zext.w	a6, a2
.Ltmp2:
	.loc	0 8 21 is_stmt 1                # vector_overlap_i32.c:8:21
	lw	a2, 4(a0)
.Ltmp3:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_overlap:b <- $x11
	#DEBUG_VALUE: vector_overlap:a <- $x10
	.loc	0 0 3 is_stmt 0                 # vector_overlap_i32.c:0:3
	li	t1, 1
	.loc	0 7 3                           # vector_overlap_i32.c:7:3
	j	.LBB0_7
.Ltmp5:
...
.LBB0_4:                                # %vector.body
	...
	#DEBUG_VALUE: vector_overlap:b <- $x11
	#DEBUG_VALUE: vector_overlap:a <- $x10
	.loc	0 8 28 is_stmt 1                # vector_overlap_i32.c:8:28
	addi	a5, a3, 8
	.loc	0 8 12 is_stmt 0                # vector_overlap_i32.c:8:12
	vl2re32.v	v10, (a3)
...
.LBB0_8:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	#DEBUG_VALUE: i <- [DW_OP_LLVM_arg 0, DW_OP_consts 4, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_minus, DW_OP_consts 4, DW_OP_div, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_stack_value] undef
	...
	lw	a2, 0(a3)
.Ltmp13:
	.loc	0 7 21 is_stmt 1                # vector_overlap_i32.c:7:21
	addi	a3, a3, 4
.Ltmp14:
	.loc	0 8 26                          # vector_overlap_i32.c:8:26
	add	a4, a4, a2
	...
	sw	a4, 0(a1)
.Ltmp15:
	#DEBUG_VALUE: i <- [DW_OP_LLVM_arg 0, DW_OP_consts 4, DW_OP_consts 4, DW_OP_LLVM_arg 0, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_minus, DW_OP_consts 4, DW_OP_div, DW_OP_consts 1, DW_OP_LLVM_arg 0, DW_OP_plus, DW_OP_plus, DW_OP_stack_value] undef
	.loc	0 7 21 is_stmt 1                # vector_overlap_i32.c:7:21
	addi	a1, a1, 4
.Ltmp16:
...
.Ldebug_info_start0:
	...
	.byte	1                               # DW_AT_low_pc
	.word	.Ltmp17-.Ltmp0                  # DW_AT_high_pc
