...
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "dotproduct_fp32.c" md5 0xe938565513ce555b7bb364cbc2590fa9
	.cfi_startproc
# %bb.0:                                # %entry
	#DEBUG_VALUE: dotproduct_fp32:len <- $x10
	#DEBUG_VALUE: dotproduct_fp32:a <- $x11
	#DEBUG_VALUE: dotproduct_fp32:b <- $x12
	#DEBUG_VALUE: dotproduct_fp32:res <- 0.000000e+00
	#DEBUG_VALUE: i <- 0
	.loc	0 5 3 prologue_end              # dotproduct_fp32.c:5:3
	beqz	a0, .LBB0_3
.Ltmp0:
# %bb.1:                                # %for.body.preheader
	...
	csrr	a3, vlenb
.Ltmp1:
	.loc	0 5 26 is_stmt 0                # dotproduct_fp32.c:5:26
	zext.w	a6, a0
.Ltmp2:
	.loc	0 5 3                           # dotproduct_fp32.c:5:3
	srli	a0, a3, 1
.Ltmp3:
	bgeu	a6, a0, .LBB0_4
.Ltmp4:
# %bb.2:
	...
	#DEBUG_VALUE: dotproduct_fp32:b <- $x12
	#DEBUG_VALUE: dotproduct_fp32:a <- $x11
	.loc	0 0 3                           # dotproduct_fp32.c:0:3
	li	a7, 0
	fmv.w.x	fa0, zero
	.loc	0 5 3                           # dotproduct_fp32.c:5:3
	j	.LBB0_7
...
.LBB0_3:
	...
	.loc	0 0 3                           # dotproduct_fp32.c:0:3
	fmv.w.x	fa0, zero
	.loc	0 7 3 is_stmt 1                 # dotproduct_fp32.c:7:3
	ret
.Ltmp6:
.LBB0_4:                                # %vector.ph
	#DEBUG_VALUE: i <- 0
...
.LBB0_5:                                # %vector.body
	...
	#DEBUG_VALUE: dotproduct_fp32:b <- $x12
	#DEBUG_VALUE: dotproduct_fp32:a <- $x11
	.loc	0 6 12                          # dotproduct_fp32.c:6:12
	vl2re32.v	v10, (a4)
	.loc	0 6 19 is_stmt 0                # dotproduct_fp32.c:6:19
	vl2re32.v	v12, (a0)
	vsetvli	a5, zero, e32, m2, ta, ma
	.loc	0 5 34 is_stmt 1                # dotproduct_fp32.c:5:34
	add	a0, a0, a3
	add	a4, a4, a3
	vfmul.vv	v10, v10, v12
	.loc	0 6 9                           # dotproduct_fp32.c:6:9
	vfredosum.vs	v8, v10, v8
	.loc	0 5 34                          # dotproduct_fp32.c:5:34
	bne	a0, t0, .LBB0_5
.Ltmp8:
# %bb.6:                                # %middle.block
	#DEBUG_VALUE: i <- 0
	...
	#DEBUG_VALUE: dotproduct_fp32:b <- $x12
	#DEBUG_VALUE: dotproduct_fp32:a <- $x11
	.loc	0 0 0 is_stmt 0                 # dotproduct_fp32.c:0
	vfmv.f.s	fa0, v8
	.loc	0 5 3                           # dotproduct_fp32.c:5:3
	beq	a7, a6, .LBB0_9
.Ltmp9:
...
.LBB0_8:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	#DEBUG_VALUE: dotproduct_fp32:b <- $x12
	#DEBUG_VALUE: dotproduct_fp32:res <- $f10_f
	...
	.loc	0 6 12 is_stmt 1                # dotproduct_fp32.c:6:12
	flw	fa5, 0(a4)
	.loc	0 6 19 is_stmt 0                # dotproduct_fp32.c:6:19
	flw	fa4, 0(a0)
	.loc	0 5 26 is_stmt 1                # dotproduct_fp32.c:5:26
	addi	a4, a4, 4
	addi	a0, a0, 4
	.loc	0 6 9                           # dotproduct_fp32.c:6:9
...
.LBB0_9:                                # %for.cond.cleanup
	#DEBUG_VALUE: dotproduct_fp32:b <- $x12
	.loc	0 7 3                           # dotproduct_fp32.c:7:3
	ret
.Ltmp13:
.Lfunc_end0:
...
.Ldebug_info_start0:
	...
	.byte	3                               # DW_AT_decl_line
	.word	116                             # DW_AT_type
	.byte	4                               # Abbrev [4] 0x4c:0xa DW_TAG_formal_parameter
	.byte	1                               # DW_AT_location
	.byte	92
	.byte	8                               # DW_AT_name
	.byte	0                               # DW_AT_decl_file
...
.Linfo_string1:
	.asciz	"dotproduct_fp32.c"             # string offset=108
.Linfo_string2:
	.asciz	"/home/preames/benchmarking/simple-vector-riscv" # string offset=126
.Linfo_string3:
	.asciz	"dotproduct_fp32"               # string offset=173
.Linfo_string4:
