...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <vscale x 2 x i32>, ptr %6, align 4, !tbaa !4
  %7 = sext <vscale x 2 x i32> %wide.load to <vscale x 2 x i64>
  %8 = getelementptr inbounds i32, ptr %b, i64 %index
  %wide.load13 = load <vscale x 2 x i32>, ptr %8, align 4, !tbaa !4
  %9 = sext <vscale x 2 x i32> %wide.load13 to <vscale x 2 x i64>
  %10 = add nsw <vscale x 2 x i64> %9, %7
  %11 = getelementptr inbounds i64, ptr %c, i64 %index
  %wide.load14 = load <vscale x 2 x i64>, ptr %11, align 8, !tbaa !8
  %12 = add nsw <vscale x 2 x i64> %10, %wide.load14
  store <vscale x 2 x i64> %12, ptr %11, align 8, !tbaa !8
...
for.body:                                         ; preds = %for.body.preheader15, %for.body
  ...
  %14 = load i32, ptr %arrayidx, align 4, !tbaa !4
  %conv = sext i32 %14 to i64
  %arrayidx2 = getelementptr inbounds i32, ptr %b, i64 %indvars.iv
  %15 = load i32, ptr %arrayidx2, align 4, !tbaa !4
  %conv3 = sext i32 %15 to i64
  %add = add nsw i64 %conv3, %conv
  %arrayidx5 = getelementptr inbounds i64, ptr %c, i64 %indvars.iv
  %16 = load i64, ptr %arrayidx5, align 8, !tbaa !8
  %add6 = add nsw i64 %add, %16
