...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert = insertelement <vscale x 4 x i32> poison, i32 %b, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = add nsw <vscale x 4 x i32> %wide.load, %broadcast.splat
  store <vscale x 4 x i32> %6, ptr %5, align 4, !tbaa !4
