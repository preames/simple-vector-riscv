...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load10 = load <vscale x 4 x i32>, ptr %6, align 4, !tbaa !4
  %7 = mul nsw <vscale x 4 x i32> %wide.load10, %wide.load
  %8 = add <vscale x 4 x i32> %7, %vec.phi
...
for.body.preheader11:                             ; preds = %for.body.preheader, %middle.block
  ...
  %res.08.ph = phi i32 [ 0, %for.body.preheader ], [ %10, %middle.block ]
  br label %for.body
...
for.body:                                         ; preds = %for.body.preheader11, %for.body
  ...
  %12 = load i32, ptr %arrayidx2, align 4, !tbaa !4
