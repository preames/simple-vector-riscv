...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %10, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> undef), !tbaa !4, !alias.scope !8
  %11 = getelementptr inbounds float, ptr %c, <16 x i64> %vec.ind
  %wide.masked.gather33 = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %11, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> undef), !tbaa !4, !alias.scope !11
  ...
  %wide.masked.gather34 = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %13, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> undef), !tbaa !4, !alias.scope !8
  %14 = getelementptr inbounds float, ptr %c, <16 x i64> %12
  %wide.masked.gather35 = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %14, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> undef), !tbaa !4, !alias.scope !11
