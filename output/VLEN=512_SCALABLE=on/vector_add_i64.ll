...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %6 = getelementptr inbounds i64, ptr %a, i64 %index
  %wide.load = load <vscale x 2 x i64>, ptr %6, align 8, !tbaa !4
  %7 = add nsw <vscale x 2 x i64> %wide.load, %broadcast.splat
  store <vscale x 2 x i64> %7, ptr %6, align 8, !tbaa !4
