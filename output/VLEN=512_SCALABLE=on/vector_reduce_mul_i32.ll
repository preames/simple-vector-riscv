...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi7 = phi <16 x i32> [ <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, %vector.ph ], [ %3, %vector.body ]
  %0 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <16 x i32>, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 16
  %wide.load8 = load <16 x i32>, ptr %1, align 4, !tbaa !4
  %2 = mul <16 x i32> %wide.load, %vec.phi
  %3 = mul <16 x i32> %wide.load8, %vec.phi7
