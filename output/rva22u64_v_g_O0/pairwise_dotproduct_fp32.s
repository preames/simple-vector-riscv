...
# %bb.0:                                # %entry
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # pairwise_dotproduct_fp32.c:4:17
	sw	a0, -52(s0)
	.loc	0 4 8 is_stmt 0                 # pairwise_dotproduct_fp32.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # pairwise_dotproduct_fp32.c:4:24
	lw	a0, -52(s0)
	.loc	0 4 31                          # pairwise_dotproduct_fp32.c:4:31
	lw	a1, -20(s0)
	.loc	0 4 29                          # pairwise_dotproduct_fp32.c:4:29
	andi	a1, a1, -2
.Ltmp2:
...
.Ltmp3:
	...
	ld	a3, -40(s0)
	.loc	0 5 17 is_stmt 0                # pairwise_dotproduct_fp32.c:5:17
	lwu	a0, -52(s0)
	...
	sh2add	a1, a0, a2
	flw	fa4, 0(a1)
	.loc	0 5 34                          # pairwise_dotproduct_fp32.c:5:34
	addiw	a1, a0, 1
...
.Ltmp4:
.LBB0_4:                                # %for.end
	.loc	0 6 1 epilogue_begin is_stmt 1  # pairwise_dotproduct_fp32.c:6:1
	addi	sp, s0, -64
	.cfi_def_cfa sp, 64
...
.Ldebug_info_start0:
	...
	.byte	0                               # End Of Children Mark
	.byte	6                               # Abbrev [6] 0x6d:0x4 DW_TAG_base_type
	.byte	5                               # DW_AT_name
	.byte	7                               # DW_AT_encoding
	.byte	4                               # DW_AT_byte_size
	.byte	7                               # Abbrev [7] 0x71:0x5 DW_TAG_pointer_type
	.word	118                             # DW_AT_type
	.byte	6                               # Abbrev [6] 0x76:0x4 DW_TAG_base_type
	.byte	7                               # DW_AT_name
