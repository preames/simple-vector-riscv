...
.Lfunc_begin0:
	...
	.loc	0 6 0                           # sparsevec_add_fp64.c:6:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -64
	...
	li	a0, 0
.Ltmp0:
	.loc	0 7 17 prologue_end             # sparsevec_add_fp64.c:7:17
	sw	a0, -60(s0)
	.loc	0 7 8 is_stmt 0                 # sparsevec_add_fp64.c:7:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 7 24                          # sparsevec_add_fp64.c:7:24
	lw	a0, -60(s0)
	.loc	0 7 28                          # sparsevec_add_fp64.c:7:28
	lw	a1, -20(s0)
.Ltmp2:
...
.Ltmp3:
	.loc	0 8 19 is_stmt 1                # sparsevec_add_fp64.c:8:19
	ld	a2, -48(s0)
	.loc	0 8 21 is_stmt 0                # sparsevec_add_fp64.c:8:21
	ld	a1, -56(s0)
	.loc	0 8 26                          # sparsevec_add_fp64.c:8:26
	lwu	a0, -60(s0)
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 7 34 is_stmt 1                # sparsevec_add_fp64.c:7:34
	lw	a0, -60(s0)
	addiw	a0, a0, 1
	sw	a0, -60(s0)
...
.Ltmp4:
.LBB0_4:                                # %for.end
	.loc	0 9 1 epilogue_begin is_stmt 1  # sparsevec_add_fp64.c:9:1
	addi	sp, s0, -64
	.cfi_def_cfa sp, 64
