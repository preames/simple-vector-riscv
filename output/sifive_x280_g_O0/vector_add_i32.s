...
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "vector_add_i32.c" md5 0xed75baea5602a75b11d594ef28760f76
	.loc	0 3 0                           # vector_add_i32.c:3:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # vector_add_i32.c:4:17
	sw	a0, -36(s0)
	.loc	0 4 8 is_stmt 0                 # vector_add_i32.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # vector_add_i32.c:4:24
	lw	a0, -36(s0)
	.loc	0 4 28                          # vector_add_i32.c:4:28
	lw	a1, -28(s0)
.Ltmp2:
	.loc	0 4 3                           # vector_add_i32.c:4:3
	bgeu	a0, a1, .LBB0_4
	j	.LBB0_2
.LBB0_2:                                # %for.body
                                        #   in Loop: Header=BB0_1 Depth=1
.Ltmp3:
	.loc	0 5 13 is_stmt 1                # vector_add_i32.c:5:13
	lw	a2, -32(s0)
	.loc	0 5 5 is_stmt 0                 # vector_add_i32.c:5:5
	ld	a1, -24(s0)
	.loc	0 5 7                           # vector_add_i32.c:5:7
	lwu	a0, -36(s0)
	.loc	0 5 5                           # vector_add_i32.c:5:5
	sh2add	a1, a0, a1
	.loc	0 5 10                          # vector_add_i32.c:5:10
	lw	a0, 0(a1)
	addw	a0, a0, a2
	sw	a0, 0(a1)
	.loc	0 5 5                           # vector_add_i32.c:5:5
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 4 36 is_stmt 1                # vector_add_i32.c:4:36
	lw	a0, -36(s0)
	addiw	a0, a0, 1
	sw	a0, -36(s0)
	.loc	0 4 3 is_stmt 0                 # vector_add_i32.c:4:3
	j	.LBB0_1
.Ltmp4:
.LBB0_4:                                # %for.end
	.loc	0 6 1 epilogue_begin is_stmt 1  # vector_add_i32.c:6:1
	addi	sp, s0, -48
	.cfi_def_cfa sp, 48
