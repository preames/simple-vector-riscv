...
# %bb.0:                                # %entry
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # ml_primitives.c:4:17
	sw	a0, -40(s0)
	.loc	0 4 8 is_stmt 0                 # ml_primitives.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # ml_primitives.c:4:24
	lw	a0, -40(s0)
	.loc	0 4 28                          # ml_primitives.c:4:28
	lw	a1, -36(s0)
.Ltmp2:
...
.Ltmp3:
	...
	ld	a1, -32(s0)
	.loc	0 5 20 is_stmt 0                # ml_primitives.c:5:20
	lwu	a0, -40(s0)
	.loc	0 5 18                          # ml_primitives.c:5:18
	sh2add	a0, a0, a1
	flw	fa0, 0(a0)
	.loc	0 5 13                          # ml_primitives.c:5:13
	call	expf
	.loc	0 5 5                           # ml_primitives.c:5:5
	ld	a1, -24(s0)
	.loc	0 5 7                           # ml_primitives.c:5:7
	lwu	a0, -40(s0)
	.loc	0 5 5                           # ml_primitives.c:5:5
	sh2add	a0, a0, a1
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 4 32 is_stmt 1                # ml_primitives.c:4:32
	lw	a0, -40(s0)
	addiw	a0, a0, 1
	sw	a0, -40(s0)
...
.Ltmp4:
.LBB0_4:                                # %for.end
	.loc	0 6 1 epilogue_begin is_stmt 1  # ml_primitives.c:6:1
	addi	sp, s0, -48
	.cfi_def_cfa sp, 48
...
.Linfo_string3:
	.asciz	"vector_expr_f32"               # string offset=171
.Linfo_string4:
...
.Linfo_string7:
	.asciz	"N"                             # string offset=197
.Linfo_string8:
	.asciz	"unsigned int"                  # string offset=199
.Linfo_string9:
	.asciz	"i"                             # string offset=212
	.section	.debug_str_offsets,"",@progbits
	.word	.Linfo_string0
	.word	.Linfo_string1
	.word	.Linfo_string2
