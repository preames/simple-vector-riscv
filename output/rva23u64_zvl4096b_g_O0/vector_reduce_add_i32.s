...
.Lfunc_begin0:
	...
	.loc	0 3 0                           # vector_reduce_add_i32.c:3:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 7 prologue_end              # vector_reduce_add_i32.c:4:7
	sw	a0, -32(s0)
.Ltmp1:
	.loc	0 5 17                          # vector_reduce_add_i32.c:5:17
	sw	a0, -36(s0)
	.loc	0 5 8 is_stmt 0                 # vector_reduce_add_i32.c:5:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp2:
	.loc	0 5 24                          # vector_reduce_add_i32.c:5:24
	lw	a0, -36(s0)
	.loc	0 5 28                          # vector_reduce_add_i32.c:5:28
	lw	a1, -28(s0)
.Ltmp3:
...
.Ltmp4:
	...
	ld	a1, -24(s0)
	.loc	0 6 14 is_stmt 0                # vector_reduce_add_i32.c:6:14
	lwu	a0, -36(s0)
	...
	addw	a0, a0, a1
	sw	a0, -32(s0)
	.loc	0 6 5                           # vector_reduce_add_i32.c:6:5
	j	.LBB0_3
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 5 36 is_stmt 1                # vector_reduce_add_i32.c:5:36
	lw	a0, -36(s0)
	addiw	a0, a0, 1
	sw	a0, -36(s0)
...
.Ltmp5:
.LBB0_4:                                # %for.end
	.loc	0 7 10 is_stmt 1                # vector_reduce_add_i32.c:7:10
	lw	a0, -32(s0)
	.loc	0 7 3 epilogue_begin is_stmt 0  # vector_reduce_add_i32.c:7:3
	addi	sp, s0, -48
	.cfi_def_cfa sp, 48
