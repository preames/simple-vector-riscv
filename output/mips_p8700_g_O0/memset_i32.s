...
my_memset:                              # @my_memset
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "memset_i32.c" md5 0xbdd0d7821896a7cb452b8ba7adf853f7
	.loc	0 3 0                           # memset_i32.c:3:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # memset_i32.c:4:17
	sw	a0, -36(s0)
	.loc	0 4 8 is_stmt 0                 # memset_i32.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # memset_i32.c:4:24
	lw	a0, -36(s0)
	.loc	0 4 28                          # memset_i32.c:4:28
	lw	a1, -28(s0)
.Ltmp2:
	.loc	0 4 3                           # memset_i32.c:4:3
	bgeu	a0, a1, .LBB0_4
	j	.LBB0_2
.LBB0_2:                                # %for.body
                                        #   in Loop: Header=BB0_1 Depth=1
.Ltmp3:
	.loc	0 5 12 is_stmt 1                # memset_i32.c:5:12
	lw	a0, -32(s0)
	.loc	0 5 5 is_stmt 0                 # memset_i32.c:5:5
	ld	a2, -24(s0)
	.loc	0 5 7                           # memset_i32.c:5:7
	lwu	a1, -36(s0)
	.loc	0 5 5                           # memset_i32.c:5:5
	sh2add	a1, a1, a2
	.loc	0 5 10                          # memset_i32.c:5:10
	sw	a0, 0(a1)
	.loc	0 5 5                           # memset_i32.c:5:5
	j	.LBB0_3
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 4 36 is_stmt 1                # memset_i32.c:4:36
	lw	a0, -36(s0)
	addiw	a0, a0, 1
	sw	a0, -36(s0)
	.loc	0 4 3 is_stmt 0                 # memset_i32.c:4:3
	j	.LBB0_1
.Ltmp4:
.LBB0_4:                                # %for.end
	.cfi_def_cfa sp, 48
	.loc	0 6 1 epilogue_begin is_stmt 1  # memset_i32.c:6:1
...
.Linfo_string1:
	.asciz	"memset_i32.c"                  # string offset=108
.Linfo_string2:
	.asciz	"/home/preames/benchmarking/simple-vector-riscv" # string offset=121
.Linfo_string3:
	.asciz	"my_memset"                     # string offset=168
.Linfo_string4:
	.asciz	"a"                             # string offset=178
.Linfo_string5:
	.asciz	"int"                           # string offset=180
.Linfo_string6:
	.asciz	"a_len"                         # string offset=184
.Linfo_string7:
