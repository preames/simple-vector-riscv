...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %broadcast.splatinsert15 = insertelement <16 x float> poison, float %a, i64 0
  %broadcast.splat16 = shufflevector <16 x float> %broadcast.splatinsert15, <16 x float> poison, <16 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load12 = load <16 x float>, ptr %2, align 4, !tbaa !4, !alias.scope !8
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec18 = and i64 %n, -8
  %broadcast.splatinsert23 = insertelement <8 x float> poison, float %a, i64 0
