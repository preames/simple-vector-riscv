...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.ind = phi <16 x i64> [ <i64 0, i64 2, i64 4, i64 6, i64 8, i64 10, i64 12, i64 14, i64 16, i64 18, i64 20, i64 22, i64 24, i64 26, i64 28, i64 30>, %vector.ph ], [ %vec.ind.next, %vector.body ]
  %offset.idx = and i64 %index, 9223372036854775792
  %10 = getelementptr inbounds float, ptr %b, <16 x i64> %vec.ind
  %wide.masked.gather = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %10, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> poison), !tbaa !4, !alias.scope !8
  %11 = getelementptr inbounds float, ptr %c, <16 x i64> %vec.ind
  %wide.masked.gather33 = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %11, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> poison), !tbaa !4, !alias.scope !11
  %12 = or <16 x i64> %vec.ind, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %13 = getelementptr inbounds float, ptr %b, <16 x i64> %12
  %wide.masked.gather34 = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %13, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> poison), !tbaa !4, !alias.scope !8
  %14 = getelementptr inbounds float, ptr %c, <16 x i64> %12
  %wide.masked.gather35 = tail call <16 x float> @llvm.masked.gather.v16f32.v16p0(<16 x ptr> %14, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x float> poison), !tbaa !4, !alias.scope !11
  %15 = fmul <16 x float> %wide.masked.gather34, %wide.masked.gather35
  %16 = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %wide.masked.gather, <16 x float> %wide.masked.gather33, <16 x float> %15)
  %17 = getelementptr inbounds float, ptr %a, i64 %offset.idx
  store <16 x float> %16, ptr %17, align 4, !tbaa !4, !alias.scope !13, !noalias !15
