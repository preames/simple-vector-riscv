...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert5 = insertelement <16 x i32> poison, i32 %b, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i32> %broadcast.splat, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 16
  store <16 x i32> %broadcast.splat6, ptr %1, align 4, !tbaa !4
