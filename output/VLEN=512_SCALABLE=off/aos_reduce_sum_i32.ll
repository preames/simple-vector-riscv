...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> %0, i32 8, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x i32> poison), !tbaa !4
  %wide.masked.gather9 = tail call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> %1, i32 8, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x i32> poison), !tbaa !4
  %2 = add <16 x i32> %wide.masked.gather, %vec.phi
  %3 = add <16 x i32> %wide.masked.gather9, %vec.phi8
