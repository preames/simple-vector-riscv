...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %wide.load15, <16 x i32> %vec.phi14)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %8 = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %wide.load21, <8 x i32> %vec.phi20)
