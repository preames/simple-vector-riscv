...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi7 = phi <16 x i32> [ zeroinitializer, %vector.ph ], [ %5, %vector.body ]
  ...
  %wide.load8 = load <16 x i8>, ptr %1, align 1, !tbaa !4
  %2 = zext <16 x i8> %wide.load to <16 x i32>
  %3 = zext <16 x i8> %wide.load8 to <16 x i32>
  %4 = add <16 x i32> %vec.phi, %2
  %5 = add <16 x i32> %vec.phi7, %3
