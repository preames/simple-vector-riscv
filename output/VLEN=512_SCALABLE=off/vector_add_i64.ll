...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert = insertelement <8 x i64> poison, i64 %b, i64 0
  %broadcast.splat = shufflevector <8 x i64> %broadcast.splatinsert, <8 x i64> poison, <8 x i32> zeroinitializer
  %broadcast.splatinsert6 = insertelement <8 x i64> poison, i64 %b, i64 0
  %broadcast.splat7 = shufflevector <8 x i64> %broadcast.splatinsert6, <8 x i64> poison, <8 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %0 = getelementptr inbounds i64, ptr %a, i64 %index
  %wide.load = load <8 x i64>, ptr %0, align 8, !tbaa !4
  %1 = getelementptr inbounds i64, ptr %0, i64 8
  %wide.load5 = load <8 x i64>, ptr %1, align 8, !tbaa !4
  %2 = add nsw <8 x i64> %wide.load, %broadcast.splat
  %3 = add nsw <8 x i64> %wide.load5, %broadcast.splat7
  store <8 x i64> %2, ptr %0, align 8, !tbaa !4
  store <8 x i64> %3, ptr %1, align 8, !tbaa !4
