...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi10 = phi <16 x i32> [ zeroinitializer, %vector.ph ], [ %7, %vector.body ]
  ...
  %wide.load11 = load <16 x i16>, ptr %1, align 2, !tbaa !4
  %2 = sext <16 x i16> %wide.load to <16 x i64>
  %3 = sext <16 x i16> %wide.load11 to <16 x i64>
  %4 = getelementptr inbounds i32, ptr %a, <16 x i64> %2
  %5 = getelementptr inbounds i32, ptr %a, <16 x i64> %3
  %wide.masked.gather = tail call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> %4, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x i32> undef), !tbaa !8
  %wide.masked.gather12 = tail call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> %5, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x i32> undef), !tbaa !8
  %6 = add <16 x i32> %wide.masked.gather, %vec.phi
  %7 = add <16 x i32> %wide.masked.gather12, %vec.phi10
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec14 = and i64 %wide.trip.count, 4294967288
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.phi17 = phi <8 x i32> [ %10, %vec.epilog.ph ], [ %14, %vec.epilog.vector.body ]
  %11 = getelementptr inbounds i16, ptr %aidx, i64 %offset.idx
  %wide.load18 = load <8 x i16>, ptr %11, align 2, !tbaa !4
  %12 = sext <8 x i16> %wide.load18 to <8 x i64>
  %13 = getelementptr inbounds i32, ptr %a, <8 x i64> %12
  %wide.masked.gather19 = tail call <8 x i32> @llvm.masked.gather.v8i32.v8p0(<8 x ptr> %13, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i32> undef), !tbaa !8
  %14 = add <8 x i32> %wide.masked.gather19, %vec.phi17
  %index.next20 = add nuw i64 %offset.idx, 8
