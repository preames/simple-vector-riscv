...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = sext <16 x i16> %wide.load to <16 x i64>
  %2 = getelementptr inbounds i32, ptr %a, <16 x i64> %1
  tail call void @llvm.masked.scatter.v16i32.v16p0(<16 x i32> %vec.ind, <16 x ptr> %2, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>), !tbaa !8
...
declare void @llvm.masked.scatter.v16i32.v16p0(<16 x i32>, <16 x ptr>, i32 immarg, <16 x i1>) #1
