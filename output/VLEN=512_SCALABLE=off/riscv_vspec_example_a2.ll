...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.load = call <64 x i8> @llvm.masked.load.v64i8.p0(ptr %4, i32 1, <64 x i1> %3, <64 x i8> poison), !tbaa !4
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.masked.load25 = call <32 x i8> @llvm.masked.load.v32i8.p0(ptr %9, i32 1, <32 x i1> %8, <32 x i8> poison), !tbaa !4
