...
; Function Attrs: argmemonly nofree norecurse nosync nounwind vscale_range(8,1024)
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check19 = icmp ult i32 %n, 64
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = icmp ult <64 x i8> %wide.load, <i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5>
  %4 = getelementptr i8, ptr %c, i64 %index
  %wide.masked.load = tail call <64 x i8> @llvm.masked.load.v64i8.p0(ptr %4, i32 1, <64 x i1> %3, <64 x i8> poison), !tbaa !4
  %predphi = select <64 x i1> %3, <64 x i8> %wide.masked.load, <64 x i8> <i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1>
  %5 = getelementptr inbounds i8, ptr %b, i64 %index
  store <64 x i8> %predphi, ptr %5, align 1, !tbaa !4
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %n.vec.remaining = and i64 %wide.trip.count, 32
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec21 = and i64 %wide.trip.count, 4294967264
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load24 = load <32 x i8>, ptr %7, align 1, !tbaa !4
  %8 = icmp ult <32 x i8> %wide.load24, <i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5, i8 5>
  %9 = getelementptr i8, ptr %c, i64 %offset.idx
  %wide.masked.load25 = tail call <32 x i8> @llvm.masked.load.v32i8.p0(ptr %9, i32 1, <32 x i1> %8, <32 x i8> poison), !tbaa !4
  %predphi26 = select <32 x i1> %8, <32 x i8> %wide.masked.load25, <32 x i8> <i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1>
  %10 = getelementptr inbounds i8, ptr %b, i64 %offset.idx
  store <32 x i8> %predphi26, ptr %10, align 1, !tbaa !4
  %index.next27 = add nuw i64 %offset.idx, 32
...
attributes #0 = { argmemonly nofree norecurse nosync nounwind vscale_range(8,1024) "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+64bit,+a,+c,+d,+f,+m,+relax,+v,+zba,+zbb,+zbc,+zbs,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl128b,+zvl256b,+zvl32b,+zvl512b,+zvl64b,-save-restore" }
