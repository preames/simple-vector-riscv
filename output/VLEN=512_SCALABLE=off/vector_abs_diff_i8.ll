...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %1 = sub i64 %c12, %b14
  %diff.check15 = icmp ult i64 %1, 128
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check16 = icmp ult i32 %N, 128
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load17 = load <64 x i8>, ptr %3, align 1, !tbaa !4
  %4 = getelementptr inbounds i8, ptr %b, i64 %index
  %wide.load18 = load <64 x i8>, ptr %4, align 1, !tbaa !4
  %5 = getelementptr inbounds i8, ptr %4, i64 64
  %wide.load19 = load <64 x i8>, ptr %5, align 1, !tbaa !4
  %6 = sub <64 x i8> %wide.load, %wide.load18
  %7 = sub <64 x i8> %wide.load17, %wide.load19
  %8 = tail call <64 x i8> @llvm.abs.v64i8(<64 x i8> %6, i1 false)
  %9 = tail call <64 x i8> @llvm.abs.v64i8(<64 x i8> %7, i1 false)
  %10 = getelementptr inbounds i8, ptr %c, i64 %index
  store <64 x i8> %8, ptr %10, align 1, !tbaa !4
  %11 = getelementptr inbounds i8, ptr %10, i64 64
  store <64 x i8> %9, ptr %11, align 1, !tbaa !4
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load24 = load <32 x i8>, ptr %13, align 1, !tbaa !4
  %14 = getelementptr inbounds i8, ptr %b, i64 %offset.idx
  %wide.load25 = load <32 x i8>, ptr %14, align 1, !tbaa !4
  %15 = sub <32 x i8> %wide.load24, %wide.load25
  %16 = tail call <32 x i8> @llvm.abs.v32i8(<32 x i8> %15, i1 false)
  %17 = getelementptr inbounds i8, ptr %c, i64 %offset.idx
  store <32 x i8> %16, ptr %17, align 1, !tbaa !4
  %index.next26 = add nuw i64 %offset.idx, 32
...
; Function Attrs: nocallback nofree nosync nounwind readnone speculatable willreturn
declare <64 x i8> @llvm.abs.v64i8(<64 x i8>, i1 immarg) #2
