...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert6 = insertelement <16 x i32> poison, i32 %b, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load5 = load <16 x i32>, ptr %1, align 4, !tbaa !4
  %2 = add nsw <16 x i32> %wide.load, %broadcast.splat
  %3 = add nsw <16 x i32> %wide.load5, %broadcast.splat7
