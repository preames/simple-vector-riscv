...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %broadcast.splatinsert6 = insertelement <16 x i32> poison, i32 %v, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i32> %broadcast.splat7, ptr %1, align 4, !tbaa !4
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %broadcast.splatinsert12 = insertelement <8 x i32> poison, i32 %v, i64 0
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <8 x i32> %broadcast.splat13, ptr %3, align 4, !tbaa !4
