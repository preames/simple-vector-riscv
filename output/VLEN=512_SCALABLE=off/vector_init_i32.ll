...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i32> %vec.ind, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 16
  store <16 x i32> %step.add, ptr %1, align 4, !tbaa !4
  %index.next = add nuw i64 %index, 32
  %vec.ind.next = add <16 x i32> %vec.ind, <i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 32>
