...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:                                # %entry
	#DEBUG_VALUE: my_strlne:s <- $x10
	addi	sp, sp, -16
	.cfi_def_cfa_offset 16
	sd	ra, 8(sp)                       # 8-byte Folded Spill
	.cfi_offset ra, -8
.Ltmp0:
	#DEBUG_VALUE: my_strlne:p <- $x10
	.loc	0 5 3 prologue_end              # strlen.c:5:3
	call	strlen
.Ltmp1:
	.loc	0 7 3                           # strlen.c:7:3
	sext.w	a0, a0
	.loc	0 7 3 epilogue_begin is_stmt 0  # strlen.c:7:3
