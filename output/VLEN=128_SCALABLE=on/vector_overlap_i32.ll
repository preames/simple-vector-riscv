...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %6 = add nsw i32 %5, -1
  %vector.recur.init = insertelement <vscale x 4 x i32> poison, i32 %.pre19, i32 %6
  %7 = tail call i32 @llvm.vscale.i32()
  %8 = shl nuw nsw i32 %7, 2
  %9 = add nsw i32 %8, -1
  %vector.recur.init20 = insertelement <vscale x 4 x i32> poison, i32 %.pre, i32 %9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vector.recur21 = phi <vscale x 4 x i32> [ %vector.recur.init20, %vector.ph ], [ %14, %vector.body ]
  %offset.idx = or i64 %index, 1
  %12 = or i64 %index, 2
  %13 = getelementptr inbounds i32, ptr %a, i64 %12
  %wide.load = load <vscale x 4 x i32>, ptr %13, align 4, !tbaa !4
  %14 = tail call <vscale x 4 x i32> @llvm.experimental.vector.splice.nxv4i32(<vscale x 4 x i32> %vector.recur, <vscale x 4 x i32> %wide.load, i32 -1)
  %15 = tail call <vscale x 4 x i32> @llvm.experimental.vector.splice.nxv4i32(<vscale x 4 x i32> %vector.recur21, <vscale x 4 x i32> %14, i32 -1)
  %16 = add nsw <vscale x 4 x i32> %14, %15
  %17 = add nsw <vscale x 4 x i32> %16, %wide.load
  %18 = getelementptr inbounds i32, ptr %b, i64 %offset.idx
  store <vscale x 4 x i32> %17, ptr %18, align 4, !tbaa !4
...
middle.block:                                     ; preds = %vector.body
  ...
  %20 = tail call i32 @llvm.vscale.i32()
  ...
  %25 = add nsw i32 %24, -1
  %vector.recur.extract22 = extractelement <vscale x 4 x i32> %14, i32 %25
...
for.body:                                         ; preds = %for.body.preheader25, %for.body
  %scalar.recur = phi i32 [ %26, %for.body ], [ %scalar.recur.ph, %for.body.preheader25 ]
  ...
  %26 = load i32, ptr %arrayidx5, align 4, !tbaa !4
  %add6 = add nsw i32 %add, %26
