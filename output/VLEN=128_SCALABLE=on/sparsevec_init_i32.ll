...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> %vec.ind, <4 x ptr> %4, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>), !tbaa !8
  call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> %step.add, <4 x ptr> %5, i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>), !tbaa !8
