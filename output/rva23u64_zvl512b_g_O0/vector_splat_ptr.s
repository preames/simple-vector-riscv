...
.Lfunc_begin0:
	...
	.loc	0 2 0                           # vector_splat_ptr.c:2:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 3 17 prologue_end             # vector_splat_ptr.c:3:17
	sw	a0, -40(s0)
	.loc	0 3 8 is_stmt 0                 # vector_splat_ptr.c:3:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 3 24                          # vector_splat_ptr.c:3:24
	lw	a0, -40(s0)
	.loc	0 3 28                          # vector_splat_ptr.c:3:28
	lw	a1, -36(s0)
.Ltmp2:
...
.Ltmp3:
	.loc	0 4 12 is_stmt 1                # vector_splat_ptr.c:4:12
	ld	a0, -32(s0)
	.loc	0 4 5 is_stmt 0                 # vector_splat_ptr.c:4:5
	ld	a2, -24(s0)
	.loc	0 4 7                           # vector_splat_ptr.c:4:7
	lwu	a1, -40(s0)
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 3 36 is_stmt 1                # vector_splat_ptr.c:3:36
	lw	a0, -40(s0)
	addiw	a0, a0, 1
	sw	a0, -40(s0)
...
.Ltmp4:
.LBB0_4:                                # %for.end
	.loc	0 5 1 epilogue_begin is_stmt 1  # vector_splat_ptr.c:5:1
	addi	sp, s0, -48
	.cfi_def_cfa sp, 48
