...
.Lfunc_begin0:
	...
	.loc	0 1 0                           # vector_add_i32_pragma_vf32_uf2.c:1:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -48
	...
	li	a0, 0
.Ltmp0:
	.loc	0 7 17 prologue_end             # vector_add_i32_pragma_vf32_uf2.c:7:17
	sw	a0, -36(s0)
	.loc	0 7 8 is_stmt 0                 # vector_add_i32_pragma_vf32_uf2.c:7:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 7 24                          # vector_add_i32_pragma_vf32_uf2.c:7:24
	lw	a0, -36(s0)
	.loc	0 7 28                          # vector_add_i32_pragma_vf32_uf2.c:7:28
	lw	a1, -28(s0)
.Ltmp2:
...
.Ltmp3:
	.loc	0 8 13 is_stmt 1                # vector_add_i32_pragma_vf32_uf2.c:8:13
	lw	a2, -32(s0)
	.loc	0 8 5 is_stmt 0                 # vector_add_i32_pragma_vf32_uf2.c:8:5
	ld	a1, -24(s0)
	.loc	0 8 7                           # vector_add_i32_pragma_vf32_uf2.c:8:7
	lwu	a0, -36(s0)
	.loc	0 8 5                           # vector_add_i32_pragma_vf32_uf2.c:8:5
	sh2add	a1, a0, a1
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 7 36 is_stmt 1                # vector_add_i32_pragma_vf32_uf2.c:7:36
	lw	a0, -36(s0)
	addiw	a0, a0, 1
	sw	a0, -36(s0)
...
.Ltmp4:
.LBB0_4:                                # %for.end
	.loc	0 9 1 epilogue_begin is_stmt 1  # vector_add_i32_pragma_vf32_uf2.c:9:1
	addi	sp, s0, -48
	.cfi_def_cfa sp, 48
