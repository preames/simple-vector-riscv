...
# %bb.1:                                # %for.body.preheader
	...
	#DEBUG_VALUE: vector_add_i32:a_len <- $x11
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	.loc	0 4 26 is_stmt 0                # vector_add_fp32.c:4:26
	zext.w	a1, a1
.Ltmp1:
...
# %bb.2:
	...
	#DEBUG_VALUE: vector_add_i32:b <- $f10_f
	#DEBUG_VALUE: vector_add_i32:a <- $x10
	.loc	0 0 3                           # vector_add_fp32.c:0:3
	li	a6, 0
	.loc	0 4 3                           # vector_add_fp32.c:4:3
	j	.LBB0_6
.Ltmp3:
...
.LBB0_4:                                # %vector.body
	...
	vfadd.vf	v8, v8, fa0
	vs2r.v	v8, (a5)
	.loc	0 4 36                          # vector_add_fp32.c:4:36
	add	a5, a5, a3
	bne	a5, a4, .LBB0_4
.Ltmp5:
# %bb.5:                                # %middle.block
...
.Ltmp8:
	...
	.loc	0 4 26                          # vector_add_fp32.c:4:26
	addi	a2, a2, 4
.Ltmp9:
	.loc	0 4 3 is_stmt 0                 # vector_add_fp32.c:4:3
	bne	a2, a0, .LBB0_7
...
.Ldebug_info_start0:
	...
	.byte	2                               # Abbrev [2] 0x27:0x39 DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.word	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.byte	3                               # DW_AT_decl_line
	.word	101                             # DW_AT_type
	.byte	5                               # Abbrev [5] 0x4f:0x10 DW_TAG_lexical_block
	.byte	0                               # DW_AT_low_pc
