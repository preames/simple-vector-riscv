...
; Function Attrs: nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) vscale_range(16,1024)
...
for.body.preheader:                               ; preds = %entry
  %min.iters.check = icmp ult i64 %len, 64
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <64 x i8>, ptr %3, align 1, !tbaa !4, !alias.scope !7
  %4 = zext <64 x i8> %wide.load to <64 x i64>
  %5 = getelementptr inbounds [256 x i16], ptr @__const.encode_byte_table.table, i64 0, <64 x i64> %4
  %wide.masked.gather = tail call <64 x i16> @llvm.masked.gather.v64i16.v64p0(<64 x ptr> %5, i32 2, <64 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <64 x i16> poison), !tbaa !10
  store <64 x i16> %wide.masked.gather, ptr %next.gep, align 1, !alias.scope !12, !noalias !7
...
for.body.preheader:                               ; preds = %entry
  %min.iters.check = icmp ult i64 %len, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %target, i64 %2
  %3 = getelementptr inbounds i8, ptr %source, i64 %index
  %wide.load = load <32 x i8>, ptr %3, align 1, !tbaa !4, !alias.scope !18
  %4 = and <32 x i8> %wide.load, <i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15, i8 15>
  %5 = lshr <32 x i8> %wide.load, <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>
  %6 = zext <32 x i8> %4 to <32 x i64>
  %7 = getelementptr inbounds [16 x i16], ptr @__const.encode_nibble_table.table, i64 0, <32 x i64> %6
  %wide.masked.gather = tail call <32 x i16> @llvm.masked.gather.v32i16.v32p0(<32 x ptr> %7, i32 2, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x i16> poison), !tbaa !10
  %8 = zext <32 x i8> %5 to <32 x i64>
  %9 = getelementptr inbounds [16 x i16], ptr @__const.encode_nibble_table.table, i64 0, <32 x i64> %8
  %wide.masked.gather18 = tail call <32 x i16> @llvm.masked.gather.v32i16.v32p0(<32 x ptr> %9, i32 2, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x i16> poison), !tbaa !10
  %10 = zext <32 x i16> %wide.masked.gather to <32 x i32>
  %11 = zext <32 x i16> %wide.masked.gather18 to <32 x i32>
  %12 = shl nuw <32 x i32> %11, <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
  %13 = or <32 x i32> %12, %10
  store <32 x i32> %13, ptr %next.gep, align 1, !alias.scope !21, !noalias !18
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
declare <32 x i16> @llvm.masked.gather.v32i16.v32p0(<32 x ptr>, i32 immarg, <32 x i1>, <32 x i16>) #1

attributes #0 = { nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) vscale_range(16,1024) "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv64" "target-features"="+64bit,+a,+c,+d,+f,+m,+relax,+v,+zba,+zbb,+zbc,+zbs,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl1024b,+zvl128b,+zvl256b,+zvl32b,+zvl512b,+zvl64b,-save-restore" }
