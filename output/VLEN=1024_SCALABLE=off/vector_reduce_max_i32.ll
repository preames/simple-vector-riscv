...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check13 = icmp ult i32 %a_len, 64
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <32 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %2, %vector.body ]
  %vec.phi14 = phi <32 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %3, %vector.body ]
  %0 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <32 x i32>, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 32
  %wide.load15 = load <32 x i32>, ptr %1, align 4, !tbaa !4
  %2 = tail call <32 x i32> @llvm.smax.v32i32(<32 x i32> %wide.load, <32 x i32> %vec.phi)
  %3 = tail call <32 x i32> @llvm.smax.v32i32(<32 x i32> %wide.load15, <32 x i32> %vec.phi14)
  %index.next = add nuw i64 %index, 64
  %4 = icmp eq i64 %index.next, %n.vec
  br i1 %4, label %middle.block, label %vector.body, !llvm.loop !8

middle.block:                                     ; preds = %vector.body
  %5 = tail call <32 x i32> @llvm.smax.v32i32(<32 x i32> %2, <32 x i32> %3)
  %6 = tail call i32 @llvm.vector.reduce.smax.v32i32(<32 x i32> %5)
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec17 = and i64 %wide.trip.count, 4294967280
  %minmax.ident.splatinsert = insertelement <16 x i32> poison, i32 %bc.merge.rdx, i64 0
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %vec.phi20 = phi <16 x i32> [ %minmax.ident.splat, %vec.epilog.ph ], [ %8, %vec.epilog.vector.body ]
  %7 = getelementptr inbounds i32, ptr %a, i64 %offset.idx
  %wide.load21 = load <16 x i32>, ptr %7, align 4, !tbaa !4
  %8 = tail call <16 x i32> @llvm.smax.v16i32(<16 x i32> %wide.load21, <16 x i32> %vec.phi20)
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %10 = tail call i32 @llvm.vector.reduce.smax.v16i32(<16 x i32> %8)
...
; Function Attrs: nocallback nofree nosync nounwind readnone speculatable willreturn
declare <32 x i32> @llvm.smax.v32i32(<32 x i32>, <32 x i32>) #1

; Function Attrs: nocallback nofree nosync nounwind readnone willreturn
declare i32 @llvm.vector.reduce.smax.v32i32(<32 x i32>) #2
