...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi13 = phi <32 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %3, %vector.body ]
  %0 = getelementptr inbounds i32, ptr %a, i64 %index
  %wide.load = load <32 x i32>, ptr %0, align 4, !tbaa !4
  %1 = getelementptr inbounds i32, ptr %0, i64 32
  %wide.load14 = load <32 x i32>, ptr %1, align 4, !tbaa !4
  %2 = tail call <32 x i32> @llvm.smax.v32i32(<32 x i32> %wide.load, <32 x i32> %vec.phi)
  %3 = tail call <32 x i32> @llvm.smax.v32i32(<32 x i32> %wide.load14, <32 x i32> %vec.phi13)
  %index.next = add nuw i64 %index, 64
  %4 = icmp eq i64 %index.next, %n.vec
  br i1 %4, label %middle.block, label %vector.body, !llvm.loop !8

middle.block:                                     ; preds = %vector.body
  %rdx.minmax.select = tail call <32 x i32> @llvm.smax.v32i32(<32 x i32> %2, <32 x i32> %3)
  %5 = tail call i32 @llvm.vector.reduce.smax.v32i32(<32 x i32> %rdx.minmax.select)
