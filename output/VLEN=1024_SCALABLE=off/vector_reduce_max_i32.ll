...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <8 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %2, %vector.body ]
  %vec.phi13 = phi <8 x i32> [ <i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321, i32 -987654321>, %vector.ph ], [ %3, %vector.body ]
...
middle.block:                                     ; preds = %vector.body
  %rdx.minmax = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %2, <8 x i32> %3)
  %5 = tail call i32 @llvm.vector.reduce.smax.v8i32(<8 x i32> %rdx.minmax)
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.vector.reduce.smax.v8i32(<8 x i32>) #1
