...
for.body.preheader:                               ; preds = %entry
  ...
  %2 = lshr i64 %1, 1
  %3 = add nuw i64 %2, 1
  %min.iters.check = icmp ult i32 %div22, 63
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.ind = phi <32 x i64> [ <i64 0, i64 2, i64 4, i64 6, i64 8, i64 10, i64 12, i64 14, i64 16, i64 18, i64 20, i64 22, i64 24, i64 26, i64 28, i64 30, i64 32, i64 34, i64 36, i64 38, i64 40, i64 42, i64 44, i64 46, i64 48, i64 50, i64 52, i64 54, i64 56, i64 58, i64 60, i64 62>, %vector.ph ], [ %vec.ind.next, %vector.body ]
  %offset.idx = and i64 %index, 9223372036854775776
  %10 = getelementptr inbounds float, ptr %b, <32 x i64> %vec.ind
  %wide.masked.gather = tail call <32 x float> @llvm.masked.gather.v32f32.v32p0(<32 x ptr> %10, i32 4, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x float> poison), !tbaa !4, !alias.scope !8
  %11 = getelementptr inbounds float, ptr %c, <32 x i64> %vec.ind
  %wide.masked.gather33 = tail call <32 x float> @llvm.masked.gather.v32f32.v32p0(<32 x ptr> %11, i32 4, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x float> poison), !tbaa !4, !alias.scope !11
  %12 = or <32 x i64> %vec.ind, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %13 = getelementptr inbounds float, ptr %b, <32 x i64> %12
  %wide.masked.gather34 = tail call <32 x float> @llvm.masked.gather.v32f32.v32p0(<32 x ptr> %13, i32 4, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x float> poison), !tbaa !4, !alias.scope !8
  %14 = getelementptr inbounds float, ptr %c, <32 x i64> %12
  %wide.masked.gather35 = tail call <32 x float> @llvm.masked.gather.v32f32.v32p0(<32 x ptr> %14, i32 4, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x float> poison), !tbaa !4, !alias.scope !11
  %15 = fmul <32 x float> %wide.masked.gather34, %wide.masked.gather35
  %16 = tail call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %wide.masked.gather, <32 x float> %wide.masked.gather33, <32 x float> %15)
  %17 = getelementptr inbounds float, ptr %a, i64 %offset.idx
  store <32 x float> %16, ptr %17, align 4, !tbaa !4, !alias.scope !13, !noalias !15
...
declare <32 x float> @llvm.masked.gather.v32f32.v32p0(<32 x ptr>, i32 immarg, <32 x i1>, <32 x float>) #2
