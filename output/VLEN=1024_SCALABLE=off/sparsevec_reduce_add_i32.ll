...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.gather = tail call <32 x i32> @llvm.masked.gather.v32i32.v32p0(<32 x ptr> %4, i32 4, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x i32> poison), !tbaa !8
  %wide.masked.gather12 = tail call <32 x i32> @llvm.masked.gather.v32i32.v32p0(<32 x ptr> %5, i32 4, <32 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <32 x i32> poison), !tbaa !8
...
middle.block:                                     ; preds = %vector.body
  ...
  %9 = tail call i32 @llvm.vector.reduce.add.v32i32(<32 x i32> %bin.rdx)
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.masked.gather19 = tail call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> %13, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <16 x i32> poison), !tbaa !8
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %16 = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %14)
