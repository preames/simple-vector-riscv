...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %broadcast.splatinsert = insertelement <16 x i64> poison, i64 %b, i64 0
  %broadcast.splat = shufflevector <16 x i64> %broadcast.splatinsert, <16 x i64> poison, <16 x i32> zeroinitializer
  %broadcast.splatinsert7 = insertelement <16 x i64> poison, i64 %b, i64 0
  %broadcast.splat8 = shufflevector <16 x i64> %broadcast.splatinsert7, <16 x i64> poison, <16 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %0 = getelementptr inbounds i64, ptr %a, i64 %index
  %wide.load = load <16 x i64>, ptr %0, align 8, !tbaa !4
  %1 = getelementptr inbounds i64, ptr %0, i64 16
  %wide.load6 = load <16 x i64>, ptr %1, align 8, !tbaa !4
  %2 = add nsw <16 x i64> %wide.load, %broadcast.splat
  %3 = add nsw <16 x i64> %wide.load6, %broadcast.splat8
  store <16 x i64> %2, ptr %0, align 8, !tbaa !4
  store <16 x i64> %3, ptr %1, align 8, !tbaa !4
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %broadcast.splatinsert14 = insertelement <8 x i64> poison, i64 %b, i64 0
  %broadcast.splat15 = shufflevector <8 x i64> %broadcast.splatinsert14, <8 x i64> poison, <8 x i32> zeroinitializer
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load13 = load <8 x i64>, ptr %5, align 8, !tbaa !4
  %6 = add nsw <8 x i64> %wide.load13, %broadcast.splat15
  store <8 x i64> %6, ptr %5, align 8, !tbaa !4
