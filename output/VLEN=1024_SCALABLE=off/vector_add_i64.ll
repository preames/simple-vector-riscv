...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert6 = insertelement <16 x i64> poison, i64 %b, i64 0
  %broadcast.splat7 = shufflevector <16 x i64> %broadcast.splatinsert6, <16 x i64> poison, <16 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load5 = load <16 x i64>, ptr %1, align 8, !tbaa !4
  %2 = add nsw <16 x i64> %wide.load, %broadcast.splat
  %3 = add nsw <16 x i64> %wide.load5, %broadcast.splat7
