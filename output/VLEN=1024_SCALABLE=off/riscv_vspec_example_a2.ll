...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.masked.load = call <128 x i8> @llvm.masked.load.v128i8.p0(ptr %4, i32 1, <128 x i1> %3, <128 x i8> poison), !tbaa !4
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.masked.load25 = call <64 x i8> @llvm.masked.load.v64i8.p0(ptr %9, i32 1, <64 x i1> %8, <64 x i8> poison), !tbaa !4
