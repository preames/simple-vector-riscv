...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i64>, ptr %1, align 8, !tbaa !4, !alias.scope !8, !noalias !11
  %2 = getelementptr inbounds i64, ptr %1, i64 16
  %wide.load14 = load <16 x i64>, ptr %2, align 8, !tbaa !4, !alias.scope !8, !noalias !11
  %3 = getelementptr inbounds i64, ptr %b, i64 %index
  %wide.load15 = load <16 x i64>, ptr %3, align 8, !tbaa !4, !alias.scope !11
  %4 = getelementptr inbounds i64, ptr %3, i64 16
  %wide.load16 = load <16 x i64>, ptr %4, align 8, !tbaa !4, !alias.scope !11
  %5 = xor <16 x i64> %wide.load15, <i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1>
  %6 = xor <16 x i64> %wide.load16, <i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1>
  %7 = and <16 x i64> %wide.load, %5
  %8 = and <16 x i64> %wide.load14, %6
  store <16 x i64> %7, ptr %1, align 8, !tbaa !4, !alias.scope !8, !noalias !11
  store <16 x i64> %8, ptr %2, align 8, !tbaa !4, !alias.scope !8, !noalias !11
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load21 = load <8 x i64>, ptr %10, align 8, !tbaa !4, !alias.scope !16, !noalias !19
  %11 = getelementptr inbounds i64, ptr %b, i64 %offset.idx
  %wide.load22 = load <8 x i64>, ptr %11, align 8, !tbaa !4, !alias.scope !19
  %12 = xor <8 x i64> %wide.load22, <i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1>
  %13 = and <8 x i64> %wide.load21, %12
  store <8 x i64> %13, ptr %10, align 8, !tbaa !4, !alias.scope !16, !noalias !19
  %index.next23 = add nuw i64 %offset.idx, 8
