...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %broadcast.splatinsert5 = insertelement <32 x i32> poison, i32 %v, i64 0
  %broadcast.splat6 = shufflevector <32 x i32> %broadcast.splatinsert5, <32 x i32> poison, <32 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <32 x i32> %broadcast.splat6, ptr %1, align 4, !tbaa !4
