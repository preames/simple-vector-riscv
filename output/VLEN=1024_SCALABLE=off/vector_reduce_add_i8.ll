...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi7 = phi <32 x i32> [ zeroinitializer, %vector.ph ], [ %5, %vector.body ]
  ...
  %wide.load8 = load <32 x i8>, ptr %1, align 1, !tbaa !4
  %2 = zext <32 x i8> %wide.load to <32 x i32>
  %3 = zext <32 x i8> %wide.load8 to <32 x i32>
  %4 = add <32 x i32> %vec.phi, %2
  %5 = add <32 x i32> %vec.phi7, %3
