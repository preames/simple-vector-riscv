...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %broadcast.splat, <32 x float> %wide.load, <32 x float> %wide.load13)
  %6 = call <32 x float> @llvm.fmuladd.v32f32(<32 x float> %broadcast.splat16, <32 x float> %wide.load12, <32 x float> %wide.load14)
