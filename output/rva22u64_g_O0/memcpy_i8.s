...
# %bb.0:                                # %entry
	...
	li	a0, 0
.Ltmp0:
	.loc	0 4 17 prologue_end             # memcpy_i8.c:4:17
	sw	a0, -44(s0)
	.loc	0 4 8 is_stmt 0                 # memcpy_i8.c:4:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 4 24                          # memcpy_i8.c:4:24
	lw	a0, -44(s0)
	.loc	0 4 28                          # memcpy_i8.c:4:28
	lw	a1, -20(s0)
.Ltmp2:
...
.Ltmp3:
	.loc	0 5 12 is_stmt 1                # memcpy_i8.c:5:12
	ld	a0, -40(s0)
	.loc	0 5 14 is_stmt 0                # memcpy_i8.c:5:14
	lwu	a2, -44(s0)
	.loc	0 5 12                          # memcpy_i8.c:5:12
	add	a0, a0, a2
	lbu	a0, 0(a0)
	.loc	0 5 5                           # memcpy_i8.c:5:5
	ld	a1, -32(s0)
	add	a1, a1, a2
...
.LBB0_3:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 4 34 is_stmt 1                # memcpy_i8.c:4:34
	lw	a0, -44(s0)
	addiw	a0, a0, 1
	sw	a0, -44(s0)
...
.LBB0_4:                                # %for.end
	.cfi_def_cfa sp, 48
	.loc	0 6 1 epilogue_begin is_stmt 1  # memcpy_i8.c:6:1
