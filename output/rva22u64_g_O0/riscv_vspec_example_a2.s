...
.Lfunc_begin0:
	...
	.loc	0 5 0                           # riscv_vspec_example_a2.c:5:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -64
	...
	li	a0, 0
.Ltmp0:
	.loc	0 6 17 prologue_end             # riscv_vspec_example_a2.c:6:17
	sw	a0, -48(s0)
	.loc	0 6 8 is_stmt 0                 # riscv_vspec_example_a2.c:6:8
	j	.LBB0_1
.LBB0_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
.Ltmp1:
	.loc	0 6 22                          # riscv_vspec_example_a2.c:6:22
	lw	a0, -48(s0)
	.loc	0 6 24                          # riscv_vspec_example_a2.c:6:24
	lw	a1, -44(s0)
.Ltmp2:
...
.Ltmp3:
	...
	ld	a0, -24(s0)
	.loc	0 7 15 is_stmt 0                # riscv_vspec_example_a2.c:7:15
	lwu	a1, -48(s0)
...
.LBB0_3:                                # %cond.true
	...
	ld	a0, -40(s0)
	.loc	0 7 27                          # riscv_vspec_example_a2.c:7:27
	lwu	a1, -48(s0)
	.loc	0 7 25                          # riscv_vspec_example_a2.c:7:25
	add	a0, a0, a1
	lbu	a0, 0(a0)
...
.LBB0_5:                                # %cond.end
	...
	ld	a1, -32(s0)
	.loc	0 7 7                           # riscv_vspec_example_a2.c:7:7
	lwu	a2, -48(s0)
	.loc	0 7 5                           # riscv_vspec_example_a2.c:7:5
	add	a1, a1, a2
	.loc	0 7 10                          # riscv_vspec_example_a2.c:7:10
	sb	a0, 0(a1)
	.loc	0 8 3 is_stmt 1                 # riscv_vspec_example_a2.c:8:3
	j	.LBB0_6
.Ltmp4:
.LBB0_6:                                # %for.inc
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 6 28                          # riscv_vspec_example_a2.c:6:28
	lw	a0, -48(s0)
	addiw	a0, a0, 1
	sw	a0, -48(s0)
...
.LBB0_7:                                # %for.end
	.cfi_def_cfa sp, 64
	.loc	0 9 1 epilogue_begin is_stmt 1  # riscv_vspec_example_a2.c:9:1
...
.Ldebug_info_start0:
	...
	.byte	2                               # Abbrev [2] 0x23:0x4a DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.word	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.byte	5                               # DW_AT_decl_line
	.word	118                             # DW_AT_type
	.byte	4                               # Abbrev [4] 0x5a:0x12 DW_TAG_lexical_block
	.byte	1                               # DW_AT_low_pc
	.word	.Ltmp5-.Ltmp0                   # DW_AT_high_pc
	.byte	5                               # Abbrev [5] 0x60:0xb DW_TAG_variable
	.byte	2                               # DW_AT_location
	.byte	145
	.byte	80
	.byte	10                              # DW_AT_name
