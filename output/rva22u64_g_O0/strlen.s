...
my_strlne:                              # @my_strlne
.Lfunc_begin0:
	.file	0 "/home/preames/benchmarking/simple-vector-riscv" "strlen.c" md5 0xeadc983ca42844ef7fb87456c6eaadf2
	.loc	0 3 0                           # strlen.c:3:0
	.cfi_startproc
# %bb.0:                                # %entry
	addi	sp, sp, -32
	...
	sd	a0, -24(s0)
.Ltmp0:
	.loc	0 4 13 prologue_end             # strlen.c:4:13
	ld	a0, -24(s0)
	.loc	0 4 9 is_stmt 0                 # strlen.c:4:9
	sd	a0, -32(s0)
	.loc	0 5 3 is_stmt 1                 # strlen.c:5:3
	j	.LBB0_1
.LBB0_1:                                # %while.cond
                                        # =>This Inner Loop Header: Depth=1
	.loc	0 5 11 is_stmt 0                # strlen.c:5:11
	ld	a0, -24(s0)
	.loc	0 5 10                          # strlen.c:5:10
	lbu	a0, 0(a0)
	.loc	0 5 3                           # strlen.c:5:3
	beqz	a0, .LBB0_3
	j	.LBB0_2
.LBB0_2:                                # %while.body
                                        #   in Loop: Header=BB0_1 Depth=1
	.loc	0 6 6 is_stmt 1                 # strlen.c:6:6
	ld	a0, -24(s0)
	addi	a0, a0, 1
	sd	a0, -24(s0)
	.loc	0 5 3                           # strlen.c:5:3
	j	.LBB0_1
.LBB0_3:                                # %while.end
	.loc	0 7 10                          # strlen.c:7:10
	ld	a0, -24(s0)
	.loc	0 7 12 is_stmt 0                # strlen.c:7:12
	ld	a1, -32(s0)
	.loc	0 7 11                          # strlen.c:7:11
	subw	a0, a0, a1
	.cfi_def_cfa sp, 32
	.loc	0 7 3 epilogue_begin            # strlen.c:7:3
...
.Ldebug_info_start0:
	...
	.byte	5                               # Abbrev [5] 0x49:0x4 DW_TAG_base_type
	.byte	4                               # DW_AT_name
	.byte	5                               # DW_AT_encoding
	.byte	4                               # DW_AT_byte_size
	.byte	6                               # Abbrev [6] 0x4d:0x5 DW_TAG_pointer_type
	.word	82                              # DW_AT_type
